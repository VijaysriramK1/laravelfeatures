...
Route::group(['middleware' => ['XSS', 'auth:api', 'json.response'], 'as' => 'api.'], function () {
    ...
    // https://example.com/api/search-student?class=2
    // https://example.com/api/search-student?section=1&class=2
    // https://example.com/api/search-student?name=Conner Stamm
    // https://example.com/api/search-student?roll_no=28229
    ...
    //example.com/android/api/group-token?id=2&body=Notification body&title=Notification title
