...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        // Student Attendance
        Route::get('student-my-attendance', ['as' => 'student_my_attendance', 'uses' => 'Student\AttendanceController@myAttendancePage'])->middleware('userRolePermission:student_my_attendance');
        ...
        Route::get('student-attendance-qr', ['as' => 'student_attendance_qr_view', 'uses' => 'Student\SmStudentPanelController@qrcode_view']);
        Route::post('student-attendance-qr', ['as' => 'student_attendance_qr', 'uses' => 'Student\SmStudentPanelController@qrcode']);
        ...
        Route::post('student-result-download', ['as' => 'student_result_download', 'uses' => 'Student\SmStudentPanelController@studentResultDownload'])->middleware('userRolePermission:student_result');
