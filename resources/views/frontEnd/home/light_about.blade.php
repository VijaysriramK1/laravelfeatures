    ...
    @if ($about)
        ...
        <section class="container box-1420">
            <div class="banner-area"
                style="background: linear-gradient(0deg, rgba(124, 50, 255, 0.6), rgba(199, 56, 216, 0.6)), url({{ $about->image != '' ? $about->image : '../img/client/common-banner1.jpg' }}) no-repeat center;">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="academic-item">
                                        ...
                                        <div class="academic-text">
                                            <h4>
                                                <a
                                                    href="{{ url('news-details/' . $value->id) }}">{{ $value->news_title }}</a>
                                            </h4>
                                            <p>
                                                {!! $value->news_body !!}
                                            </p>
                                            <div>
                                                <a href="{{ url('news-details/' . $value->id) }}" class="client-btn">Read
                                                    More</a>
                                            </div>
                                        </div>
                                    </div>
