                    ...
                    <div class="row">
                            ...
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100"
                                        src="{{ asset('public/backEnd/img/client/news/news1.jpg') }}" alt="">
                                </div>
                                <div class="news-text">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="news-item">
                                <div class="news-img">
                                    <img class="img-fluid w-100"
                                        src="{{ asset('public/backEnd/img/client/news/news2.jpg') }}" alt="">
                                </div>
                                <div class="news-text">
                                    <p class="date">17th Nov, 2018</p>
                                    <h4>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="academic-item">
                                <div class="academic-img">
                                    <img class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/academics/academic1.jpg') }}"
                                        alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="academic-item">
                                <div class="academic-img">
                                    <img class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/academics/academic2.jpg') }}"
                                        alt="">
                                </div>
                                <div class="academic-text">
                                    <h4>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="academic-item">
                                <div class="academic-img">
                                    <img class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/academics/academic3.jpg') }}"
                                        alt="">
                                </div>
                                <div class="academic-text">
                                    <h4>
                    ...
                    <div class="row">
                            ...
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/events/event1.jpg') }}"
                                        alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/events/event2.jpg') }}"
                                        alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/events/event3.jpg') }}"
                                        alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="events-item">
                                <div class="card">
                                    <img class="card-img-top" class="img-fluid"
                                        src="{{ asset('public/backEnd/img/client/events/event4.jpg') }}"
                                        alt="">
                                    <div class="card-body">
                                        <h5 class="card-title">
                                            Structural study of
                        ...
                        <div class="d-flex justify-content-center">
                            <div class="thumb">
                                <img class="img-fluid rounded-circle"
                                    src="{{ asset('public/backEnd/img/client/testimonial/person1.jpg') }}"
                                    alt="">
                            </div>
            ...
            <div class="row footer_inner">
                    ...
                    <aside class="f_widget ab_widget">
                        ...
                        <ul>
                            <li><a href="#"></a>Business</a></li><a href="#">
                                <li><a href="#"></a>Energy & Environmental Sciences
                            </a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <aside class="f_widget ab_widget">
                        ...
                        <ul>
                            <li><a href="#"></a>SGA Health Care</a></li><a href="#">
                                <li><a href="#"></a>SGA Children’s Health
                            </a></li>
                            <li><a href="#"></a>Interdisciplinary Research</a></li>
                            <li><a href="#"></a>SGA Online</a></li>
                            <li><a href="#"></a>SGA Research Centers</a></li>
                        </ul>
                    </aside>
                </div>
                <div class="col-lg-3 col-sm-6">
            ...
            <div class="row single-footer-widget">
                <div class="col-lg-8 col-md-9">
                    <div class="copy_right_text">
                        <p>Copyright © 2018 All rights reserved <a href="#">SGA</a>. The Ultimate Education ERP
                        </p>
                    </div>
                </div>
