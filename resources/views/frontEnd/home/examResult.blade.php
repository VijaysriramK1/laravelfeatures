@php $page_title="All about SGA School management system; School management software"; @endphp
        ...
        <div class="container">
            <form method="GET" action="{{ route('examResultSearch') }}">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 mt-30-md md_mb_20">
                        <div class="primary_input">
                            <label class="primary_input_label" for="">@lang('exam.admission_number')<span class="text-danger">
                                    *</span></label>
                            <input
                                class="primary_input_field form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}"
                                placeholder="@lang('exam.admission_number')*" type="text" name="admission_number" value="">
                        </div>
