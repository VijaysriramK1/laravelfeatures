...
<head>
    ...
    <title>{{ $setting->site_title ? $setting->site_title : 'SMA Edu ERP' }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('public/') }}/frontend/css/sga.css" />
    <x-root-css />
                ...
                <div class="container box-1420">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}/home">
                        <img class="w-75"
                            ...
                            alt="SGA Logo" style="max-width: 150px;">
                    </a>
                    ...
                    @else
                        ...
                        @if (moduleStatusCheck('Certificate'))
                            <li class="nav-item"> <a class="nav-link"
                                    href="{{ route('certificate.verify-certificate') }}">{{ __('certificate.Certificate') }}</a>
                            </li>
                        @endif
            ...
            <div class="row single-footer-widget">
                <div class="col-lg-8 col-md-9">
                    <div class="copy_right_text">
                        ...
                        @else
                            Copyright © 2019 All rights reserved | This application is made with by SG Academy
                        @endif
                    </div>
                </div>
