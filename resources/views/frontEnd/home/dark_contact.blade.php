        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="offset-lg-1 col-lg-5">
                    ...
                    <form class="row contact_form mt-50" action="#" method="post" id="contactForm"
                        novalidate="novalidate">
                        <div class="col-lg-12">
                            <div class="primary_input">
                                <input class="primary_input_field form-control" placeholder="Enter your name"
                                    type="text" id="">

                            </div>
                            <div class="primary_input mt-20">
                                <input class="primary_input_field form-control" placeholder="info@sgacademy.com"
                                    type="text" id="">

                            </div>
                            <div class="primary_input mt-20">
                                <input class="primary_input_field form-control" placeholder="Enter Subject"
                                    type="text" id="">
