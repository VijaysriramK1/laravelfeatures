...
<head>
    ...
    <title> SGA school management software & School management system </title>
    <meta name="description"
        content="SGA is 100+ unique feature enable school management software system. It can manage all type of school, academy and any educational institution. ">
    <meta name="keywords"
...
[ {
  ...
  "name" : "SG ERP - Best School Management software system",
  ...
  "screenshot" : "http://example.com/public/landing/img/dashboard_preview.png",
  "softwareVersion" : "2.0",
  ...
  "review" : {
    ...
    <meta name="twitter:site" content="@SgEdu" />
    <meta name="twitter:creator" content="@SgEdu" />
    ...
    <meta name="twitter:description"
        content="SGA is a well known School management system and its ERP based Software. So try the free demo today!. Cause SGA offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!" />
    <meta property="og:image" content="http://example.com/public/landing/img/dashboard_preview.png" />


    <!-- Open Graph data -->
    <meta property="og:type" content="website" />
    <meta property="og:url" content="//example.com/" />
    <meta property="og:image" content="//example.com/public/landing/img/dashboard_preview.png" />
    <meta property="og:title" content="School Management ERP Software & School Management System - SGA" />

    <meta property="og:description"
        content="SGA is a well known School management system and its ERP based Software. So try the free demo today!. Cause SGA offers 100+  featured, well-documented and latest academic management software system.. By this multipurpose software system, you can easily manage your school,  university or any kind of organization educational institute. So we can provide you speedy, Secure and clean coded Flexible academy and school management system at affordable prices!" />
    <meta property="og:site_name" content="SGA" />

    <link rel="canonical" href="http://example.com" hreflang="en-us" />
                    ...
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            ...
                            <p>Managing various administrative tasks in one place is now quite easy and time
                                savior with this SG ERP and Give your valued time to your institute that will
                                increase next generation productivity for our society.</p>
                            @if (!moduleStatusCheck('Saas'))
                                <a class="btn_1" target="_blank"
                                    href="mailto:support@example.com?subject=Request for saas school demo!&body=This is only a test!">
                                    <i class="ti-email"></i> For Saas Demo</a>
                            @endif
                            <a href="{{ url('/login') }}" class="btn_2" target="_blank"> <i class="ti-package"></i> Try
                                Live Demo</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        ...
                        <!-- <a class="btn_1 d-none d-lg-block" target="_blank" href="http://salespanel.example.com/">Purchase</a> -->
                        <a class="btn_1 d-none d-lg-block" target="_blank" href="#">Purchase</a>
                    </nav>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>SG ERP has all in one place. You’ll find everything what you are looking into education
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="single_feature">
                        <div class="single_feature_part">
                            ...
                            <p>You know! Smart Idea always comes to well planners. And Our SG ERP is Smart for its Well
                                Documentation.
                            </p>
                        </div>
                    </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-5 col-lg-5">
                    <div class="video_section_text">
                        <h2>Take A look Our SG ERP Overview in Video</h2>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-md-8">
                    <div class="section_tittle text-center">
                        <h5>AMazing Features</h5>
                        <h2>More Features Has SG ERP</h2>
                        <p>it's vast! SGA has more additional feature that will expect in a complete solution.</p>
                    </div>
                </div>
            </div>
            <div class="row justify-content-center">
    ...
    <section class="contact_us padding_top" id="Support">
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6">
                    <a href="https://ticket.example.com/help-center" target="_blank">
                        <div class="single_feature">
                            <div class="single_feature_part">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="footer_area_text">
                        ...
                        <p>We Believe! It won’t a wrong decision in Purchasing our SG ERP for your Institute.</p>
                        <!-- <a href="http://salespanel.example.com/" class="footer_btn"> <i class="ti-shopping-cart-full"></i> -->
                        <a href="#" target="_blank" class="footer_btn"> <i
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="copyright_text">
                        <p> <img src="{{ asset('public/landing/img/copyright.svg') }}" alt="#"> 2019-2020
                            SgEdu - Ultimate Education ERP. All Rights
