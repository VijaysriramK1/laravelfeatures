...
if (isset($setting->copyright_text)) {
    ...
    generalSetting()->copyright_text = 'Copyright © 2019 All rights reserved |  is made with by SG Academy';
}
...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('public/backEnd/') }}/css/sga.css" />
                        ...
                        <div class="form-wrap text-center">
                            ...
                            <form method="POST" class="" action="{{ url('register') }}">
                                ...
                                <div class="d-flex justify-content-between pl-30">
                                    <div>
                                        <a href="{{ route('recoveryPassord') }}">Have already an account ? Login
                                            here</a>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-12 text-center">
                    <p>Copyright © 2019 All rights reserved | This application is made with <span
                            class="ti-heart"></span> by SG Academy</p>
                    </p>
                </div>
            </div>
        </div>
