        ...
        <div class="col-lg-12">
            ...
            <nav>
                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                   ...
                   <a href="{{route('status-index')}}"> <button class="nav-link active" id="nav-Status-tab" data-bs-toggle="tab" data-bs-target="#nav-Status" type="button" role="tab" aria-controls="nav-Status" aria-selected="false"><b>Status</b></button></a>
                </div>
            </nav><br>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        @if (isset($status))
                                                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['status-update', $status->id], 'method' => 'PUT']) }}
                                                        @else
                                                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'status-store', 'method' => 'POST']) }}
                                                        @endif
                                                        <div class="white-box">
                                                            <div class="main-title">
                                                                <h3 class="mb-15">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12">
                                                                        <div class="primary_input">
                                                                            <label class="primary_input_label" for="name">@lang('status Title') <span class="text-danger"> *</span></label>
                                                                            <input
                                                ...
                                                <div class="white-box">
                                                    <div class="row">
                                                        <div class="col-lg-4 no-gutters">
                                                            <div class="main-title">
                                                                <h3 class="mb-15"> @lang('status List')</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                                    ...
                                                                    <tbody>
                                                                        @foreach($statuses as $key => $status)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <x-drop-down>
                                                                                        <a class="dropdown-item" href="{{ route('status-edit', [$status->id]) }}">Edit</a>
                                                                                        <a class="dropdown-item" data-toggle="modal" data-target="#deleteDormitoryListModal{{ $status->id }}" href="#">Delete</a>
                                                                                    </x-drop-down>
                                                                                </td>
                                                                            </tr>
                                                                            <div class="modal fade admin-query" id="deleteDormitoryListModal{{ $status->id }}">
                                                                                    ...
                                                                                    <div class="modal-content">
                                                                                        ...
                                                                                        <div class="modal-body">
                                                                                            <div class="text-center">
                                                                                                <h4>Are you sure to delete this status ?</h4>
                                                                                            </div>
                                                                                            <div class="mt-40 d-flex justify-content-between">
                                                                                                <button type="button" class="primary-btn tr-bg" data-dismiss="modal">Cancel</button>
                                                                                                {{ Form::open(['route' => ['status-delete', $status->id], 'method' => 'DELETE']) }}
