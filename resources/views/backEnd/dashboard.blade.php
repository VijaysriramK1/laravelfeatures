                ...
                <div class="white-box">
                            ...
                            <div class="main-title">
                                @if (isSubscriptionEnabled() && auth()->user()->role_id == 1 && saasDomain() != 'school')
                                    <h3 class="mb-15">@lang('dashboard.welcome') - {{ @Auth::user()->school->school_name }} |
                                        ...
                                        @lang('dashboard.student') : {{ @$totalStudents }} out
                                        {{ @$package_info['student_quantity'] }}
                                        |
                    ...
                    @if (Auth::user()->is_saas == 0)
                        <div class="row row-gap-24">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('class') }}" class="d-block">
                                    <div class="white-box single-summery cyan">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h3>@lang('dashboard.classes')</h3>
                                                <p class="mb-0">@lang('dashboard.total_classes')</p>
                                            </div>
                                            <h1 class="gradient-color2">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('class') }}" class="d-block">
                                    <div class="white-box single-summery blue">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h3>@lang('dashboard.live_classes')</h3>
                                                <p class="mb-0">@lang('dashboard.total_live_classes_based_on_routine')</p>
                                            </div>
                                            <h1 class="gradient-color2">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('student_list') }}" class="d-block">
                                    <div class="white-box single-summery violet">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h3>@lang('dashboard.present')</h3>
                                                <p class="mb-0">@lang('dashboard.class_wise_present_students')</p>
                                            </div>
                                            <h1 class="gradient-color2">
                                                @if (isset($presentStudents))
                                                    {{ $presentStudents }}
                                                @endif
                                            </h1>
                                        </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                <a href="{{ route('student_list') }}" class="d-block">
                                    <div class="white-box single-summery fuchsia">
                                        <div class="d-flex justify-content-between">
                                            <div>
                                                <h3>@lang('dashboard.absent')</h3>
                                                <p class="mb-0">@lang('dashboard.class_wise_leave_students')</p>
                                            </div>
                                            <h1 class="gradient-color2">
                                                @if (isset($leaveStudents))
                                                    {{ $leaveStudents }}
                                                @endif
                                            </h1>
                                        </div>
                        ...
                        <div class="white-box">
                            <div class="row justify-content-between">
                                <div class="col-lg-8 col-md-9 col-8">
                                    <div class="main-title">
                                        <h3 class="mb-0"> @lang('dashboard.income_and_expenses_for') {{ date('M') }} {{ $year }}
                                        </h3>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div id="barChartDiv" class="mt-15">
                                        <div class="row padding4 row-gap-24">
                                            ...
                                            @endif
                                            <div class="col-lg-12">
                                                <div id="commonBarChart" style="height: 350px; padding-right: 20px;">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                ?>
                                        <tr>
                                            ...
                                            <td class="d-flex justify-content-around">
                                                <a href="{{ route('view-notice', @$notice->id) }}"
                                                    title="@lang('common.view_notice')" class="primary-btn small tr-bg modalLink"
                                                    data-modal-size="modal-lg"><span class="ti-eye"></span></a>
                                            </td>
                                        </tr>
                                        <?php
                                // }
        ...
        <section class="mt-40">
            <div class="container-fluid p-0">
                <div class="row">
                    ...
                    @endif
                    <div class="col-lg-5 col-xl-4 mt-50-md md_sma_50">
                                                        ...
                                                        <div class="col-lg-12" id="sibling_class_div">
                                                            <div class="primary_input">
                                                                ...
                                                                <input class="primary_input_field form-control"
                                                                    type="text" name="todo_title" id="todo_title">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 text-right col-md-6 col-6">
                                                <a href="#" data-toggle="modal" class="primary-btn small fix-gr-bg"
                                                    data-target="#add_to_do" title="Add To Do"
...
@elseif(!empty($get_the_data))
    @section('mainContent')
            ...
            <div class="container-fluid p-0">
                <div class="white-box">
                            ...
                            <div class="main-title">
                                @if (isSubscriptionEnabled() && auth()->user()->role_id == 1 && saasDomain() != 'school')
                                    <h3 class="mb-15">@lang('dashboard.welcome') - {{ @Auth::user()->school->school_name }} |
                                        ...
                                        {{ @$package_info['student_quantity'] }}
                                        |
                                        @lang('common.staff') : {{ @$totalStaffs }} out
                                        {{ @$package_info['staff_quantity'] }}
                                    </h3>
                                @else
                                    <h3 class="mb-15">@lang('dashboard.welcome') - {{ @Auth::user()->school->school_name }} |
                                        {{ @Auth::user()->roles->name }}</h3>
                    ...
                    <div class="row row-gap-24">
                        ...
                        @if (in_array('number-of-student', $get_the_data))
                            @if (userPermission('number-of-student'))
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <a href="{{ route('student_list') }}" class="d-block">
                                        <div class="white-box single-summery cyan">
                        ...
                        @if (in_array('number-of-teacher', $get_the_data))
                            @if (userPermission('number-of-teacher'))
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <a href="{{ route('staff_directory') }}" class="d-block">
                                        <div class="white-box single-summery violet">
                        ...
                        @if (in_array('number-of-parent', $get_the_data))
                            @if (userPermission('number-of-parent'))
                                {{-- mt-30-md --}}
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <a href="#" class="d-block">
                        ...
                        @if (in_array('number-of-staff', $get_the_data))
                            @if (userPermission('number-of-staff'))
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <a href="{{ route('staff_directory') }}" class="d-block">
                                        <div class="white-box single-summery fuchsia">
        ...
        <div class="chart_grid chart_container">
            ...
            @if (in_array('month-income-expense', $get_the_data))
                @if (userPermission('month-income-expense'))
                    <section class="" id="incomeExpenseDiv">
                        <div class="container-fluid p-0">
                            <div class="white-box">
                                <div class="row justify-content-between">
                                    <div class="col-lg-8 col-md-9 col-8">
                                        <div class="main-title">
                                            <h3 class="mb-0"> @lang('dashboard.income_and_expenses_for') {{ date('M') }}
                                                {{ $year }}
                                            </h3>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 text-right col-md-3 col-4 nowrap">
                                        <button type="button"
                                            class="primary-btn small tr-bg icon-only  dashboard_collapse"
                                            id="barChartBtn">
                                            <span class="pr ti-angle-down"></span>
                                        </button>
            ...
            @if (in_array('year-income-expense', $get_the_data))
                @if (userPermission('year-income-expense'))
                    <section id="incomeExpenseSessionDiv">
                        <div class="container-fluid p-0">
                            <div class="white-box">
        ...
        @if (in_array('notice-board', $get_the_data))
            @if (userPermission('notice-board'))
                <section class="mt-40">
                    <div class="container-fluid p-0">
                        <div class="white-box">
        ...
        <section class="mt-40">
            <div class="container-fluid p-0">
                <div class="row">
                    ...
                    @if (in_array('calender-section', $get_the_data))
                        @if (userPermission('calender-section'))
                            <div class="col-lg-7 col-xl-8">
                                <div class="row">
                                    <div class="col-lg-12">
                    ...
                    <div class="col-lg-5 col-xl-4 mt-50-md md_sma_50">
                        ...
                        @if (in_array('to-do-list', $get_the_data))
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="white-box school-table">
                                        @if (userPermission('to-do-list'))
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 text-right col-md-6 col-6">
                                                    <a href="#" data-toggle="modal"
                                                        class="primary-btn small fix-gr-bg" data-target="#add_to_do"
                                            ...
                                            @if (count(@$toDos->where('complete_status', 'C')) > 0)
                                                @foreach ($toDos->where('complete_status', 'C') as $toDoListsCompleted)
                                                    <div class="single-to-do d-flex justify-content-between"
                                                        id="to_do_list_div{{ @$toDoListsCompleted->id }}">
                                                        <div>
                                                            <h5 class="d-inline">{{ @$toDoListsCompleted->todo_title }}
                                                            </h5>
                                                            <p class="">
