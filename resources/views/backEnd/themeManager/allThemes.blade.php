...
<section class="admin-visitor-area up_admin_visitor">
    <div class="container-fluid p-0">
            ...
            <div class="col-lg-12">
                <div class="row">
                        ...
                        <div style="border:1px solid;" class="card">
                            <div style="padding: 0;" class="card-body screenshot">
                                <div class="single_item_img_div">
                                    <img style="width: 100%" src="{{asset('public/theme/edulia/img/edulia.jpg')}}" alt="">
                                </div>
                            </div>
                    ...
                    <div style="position: relative;" class="col-xl-4 col-md-6 item_section @if(activeTheme() != 'edulia') active_theme @endif"">
                        ...
                        <div style="padding: 0;" class="card-body screenshot">
                            <div class="single_item_img_div">
                                <img style="width: 100%" src="{{asset('public/theme/default/img/default.jpg')}}" alt="">
                            </div>
                        </div>
                        <div class="card-footer d-flex">
                            <div class="d-flex flex-grow-1 align-items-center gap-10">
        ...
        <!-- <div class="col-lg-12">
            <div class="row">
                <div style="position: relative;" class="col-xl-4 col-md-6 item_section @if(activeTheme() == 'Filament') active_theme @endif">
                    <div style="border:1px solid;" class="card">
                        <div style="padding: 0;" class="card-body screenshot">
                            <div class="single_item_img_div">
                                <img style="width: 100%" src="{{asset('public/theme/filament/filament-minimal-theme.webp')}}" alt="">
                            </div>
                        </div>
                        <div class="card-footer d-flex">
                            <div class="d-flex flex-grow-1 align-items-center gap-10">
                                <div class="flex-grow-1">
                                    <h4 class="theme_name">@if(activeTheme() == 'Filament')Active : @endif Filament</h4>
                                </div>
                                @if(activeTheme() != 'Filament')
                                <div class="text-center active_btn">
                                    <a href="javascript:void(0)" onclick="themeActive('Filament')">Active</a>
                                </div>
                                @endif
                            </div>
                        </div>
