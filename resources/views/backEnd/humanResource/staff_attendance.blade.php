                ...
                <div class="col-lg-12">
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <a href="{{ route('staff-attendance-import') }}"
                                    class="primary-btn small fix-gr-bg pull-right "><span
                                        class="ti-plus pr-2"></span>@lang('hr.import_attendance')</a>
                            </div>
                        </div>


                        {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'staff-attendance-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'sma_form']) }}
