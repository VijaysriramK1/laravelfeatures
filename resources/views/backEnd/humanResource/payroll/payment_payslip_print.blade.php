                ...
                <tr>
                    <th>
                        <div class="numbered_table_row" style="justify-content:center">
                            <h3>
                                @lang('hr.payslip_for_the_period_of') {{ $payrollDetails->payroll_month }}
                                {{ $payrollDetails->payroll_year }}
                            </h3>
                        </div>
                    </th>
                </tr>
        ...
        <table class="custom_table custom_table2">
            <thead>
                <tr>
                    <td class="border-0 full_name_header">
                        <h4 class="muted_text font_14">
                            @lang('hr.payslip') #@if (isset($payrollDetails))
                                {{ $payrollDetails->id }}
                            @endif
                        </h4>
                    </td>
                ...
                <tr>
                    ...
                    <th>
                        @if (isset($payrollDetails))
                            {{ $payrollDetails->staffs->staff_no }}
                        @endif
                    </th>
                    <th>@lang('common.name')</th>
                    <th>
                        @if (isset($payrollDetails))
                            {{ $payrollDetails->staffDetails->full_name }}
                        @endif
                    </th>
                </tr>
                <tr>
                    ...
                    <th>
                        @if (isset($payrollDetails))
                            {{ $payrollDetails->staffDetails->departments->name }}
                        @endif
                    </th>
                    <th>@lang('hr.designation')</th>
                    <th>
                        @if (isset($payrollDetails))
                            {{ $payrollDetails->staffDetails->designations->title }}
                        @endif
                    </th>
                </tr>
                <tr>
                    <th>@lang('accounts.payment_mode')</th>
                    <th> {{ $payrollPayment->paymentMethod->method }}
                    </th>
                    <th>@lang('hr.basic_salary')</th>
                    <th>
                        @if (isset($payrollDetails))
                            {{ currency_format($payrollDetails->basic_salary) }}
                        @endif
                    </th>
                </tr>
                <tr>
                    ...
                    <th>
                        @if (isset($payrollDetails))
                            {{ currency_format($payrollDetails->gross_salary) }}
                        @endif
                    </th>
                    <th>@lang('hr.net_salary')</th>
                    <th>
                        @if (isset($payrollDetails))
                            {{ currency_format($payrollDetails->net_salary) }}
                        @endif
                    </th>
                </tr>
                <tr>
                    ...
                    <th>
                        @if (isset($payrollDetails))
                            {{ currency_format($payrollPayment->amount) }}
                        @endif
                    </th>
                    <th>@lang('hr.due')</th>
                    <th> {{ currency_format($payrollDetails->net_salary - $payrollPayment->amount) }}</th>
                </tr>
