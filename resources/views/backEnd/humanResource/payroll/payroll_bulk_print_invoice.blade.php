                            ...
                            <tr>
                                <th>
                                    <div class="numbered_table_row" style="justify-content:center">
                                        <h3>
                                            @lang('hr.payslip_for_the_period_of') {{ $payrollDetail->payroll_month }}
                                            {{ $payrollDetail->payroll_year }}
                                        </h3>
                                    </div>
                                </th>
                            </tr>
                            ...
                            <tr>
                                <td class="border-0 full_name_header">
                                    <h4 class="muted_text font_14">
                                        @lang('hr.payslip') #@if (isset($payrollDetail))
                                            {{ $payrollDetail->id }}
                                        @endif
                                    </h4>
                                </td>
                            ...
                            <tr>
                                ...
                                <th>
                                    @if (isset($payrollDetail))
                                        {{ $payrollDetail->staffDetails->staff_no }}
                                    @endif
                                </th>
