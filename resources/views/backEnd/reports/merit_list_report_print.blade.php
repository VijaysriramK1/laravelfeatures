        ...
        <div class="invoice_print">
            <div class="container">
                <div class="invoice_part_iner">
                    <table
                        class="table border_bottom m-0 {{ resultPrintStatus('header') ? 'tableInfo_header' : 'tableInfo_header custom_result_print' }}"
                        style="margin: 0">
                        <thead>
                            <td>
                                <div class="logo_img">
                                    ...
                                    <div class="company_info">
                                        ...
                                        <p>{{ isset(generalSetting()->address) ? generalSetting()->address : 'SGA School Address' }}
                                        </p>
                                        <p>@lang('common.email'):
                        ...
                        <td>
                            <table class="mb_30 mr_auto">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h4 class="table_title">@lang('exam.order_of_merit_list')</h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <p class="line_grid">
                                                <span><span>@lang('exam.exam')</span><span>:</span></span>{{ $exam_name }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p class="line_grid">
                                                <span><span>@lang('common.search')</span><span>:</span></span>{{ $class_name }}
                                            </p>
                                        </td>
                                    </tr>
                                    <tr>
                        ...
                        <td>
                            <table class="mb_30 max-width-500 mr_auto">
                                <tbody>
                                    <tr>
                                        <td>
                                            <h4 class="table_title">@lang('common.subjects')</h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                ...
                <tbody>
                    @foreach ($allresult_data as $key => $row)
                        ...
                        <tr>
                            ...
                            <td>{{ @getStudentMeritPosition($InputClassId, $InputSectionId, $InputExamId, $row->studentinfo->studentRecord->id) }}
                            </td>
