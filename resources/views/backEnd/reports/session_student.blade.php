                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 mt-30-md">
                                ...
                                <div class="primary_input">
                                    <input class="primary_input_field" type="text" name="admission_number"
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        ...
                                                        <div>
                                                            ...
                                                            <img class="report-admit-img"
                                                                src="{{ asset($studentDetails->student_photo) }}"
                                                    ...
                                                    <div class="card-body">
                                                        <div class="white-box">
                                                            ...
                                                            <div class="row mt-20">
                                                                <div class="col-lg-6">
                                                                    <strong>@lang('common.name'):</strong>
                                                                    {{ $studentDetails->full_name }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                                    <strong>@lang('reports.transcript_none'):</strong>
                                                            ...
                                                            <div class="row mt-20">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    @php
                                                                        $mother = App\SmStudent::where('sm_students.id', $studentDetails->student_id)
                                                                            ->join('sm_parents', 'sm_parents.id', '=', 'sm_students.parent_id')
                                                                            ->first();
                                                                    @endphp
                                                                    <strong>@lang('student.mother_name'):</strong>
                                                                    {{ $mother->mothers_name }}
                                                                </div>
                                                                <div class="col-lg-6">
                                                            ...
                                                            <div class="row  mt-40 ">
                                                                <div class="offset-md-2 col-lg-4">
                                                                    <strong>@lang('common.name'):</strong>
                                                                    {{ $studentDetails->full_name }}<br>
                                                                    <strong>@lang('common.class'):</strong>
                                                                    {{ $current_class->class_name }}<br>
                                                                    <strong>@lang('common.section') :</strong>
                                                                    {{ $current_section->section_name }}<br>
                                                                    <strong>@lang('student.admission_no'):</strong>
                                                                    {{ $studentDetails->admission_number }}<br>
                                                                </div>
                                                                <div class="col-lg-4">
                                                                    <strong>@lang('reports.transcript_none'):</strong> 23423423<br>
                                                                    <strong>@lang('common.academic_year'):</strong>
                                                                    {{ $current_session->year }}<br>
                                                            ...
                                                            @foreach ($promotes as $studentDetails)
                                                                ...
                                                                @if ($is_result_available->count() > 0)
                                                                    <div class="row  mt-40 ">
                                                                        ...
                                                                        <div class="col-lg-3">
                                                                            <strong>@lang('student.roll'):</strong>
                                                                            {{ $studentDetails->previous_roll_number }}
                                                                        </div>
                                                                        <div class="col-lg-3">
                                                                            <strong>@lang('common.class'):</strong>
                                                                            @php
                                                                ...
                                                                ?>
                                                                                    ...
                                                                                    <td>
                                                                                        @php
                                                                                            if ($totalSubjectFail > 0) {
                                                                                                ...
                                                                                                $mark_grade = App\SmMarksGrade::where([['percent_from', '<=', $totalSumSub], ['percent_upto', '>=', $totalSumSub]])
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="{{ $colspan / 2 - 1 }}"
                                                                                    class="text-center">@lang('exam.total_marks')
                                                                                </td>
                                                                                <td colspan="{{ $colspan / 2 + 1 }}"
                                                                                    class="text-center">{{ $total_marks }}
                                                                                </td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td colspan="{{ $colspan / 2 - 1 }}"
                                                                                    class="text-center">@lang('exam.total_grade')
                                                                                </td>
                                                                                <td colspan="{{ $colspan / 2 + 1 }}"
                                                                                    class="text-center">
                                                                                    @php
                                                                                        if ($total_fail != 0) {
                                                                                            ...
                                                                                            $average_grade = App\SmMarksGrade::where([['percent_from', '<=', $totalSumSub], ['percent_upto', '>=', $totalSumSub]])
                                                                                                ->where('academic_id', getAcademicId())
                                                                                                ->first();
                                                                            ...
                                                                            <tr>
                                                                                <td colspan="{{ $colspan / 2 - 1 }}"
                                                                                    class="text-center">@lang('reports.total_gpa')
                                                                                </td>
                                                                                <td colspan="{{ $colspan / 2 + 1 }}"
                                                                                    class="text-center">
                                                                                    @php
