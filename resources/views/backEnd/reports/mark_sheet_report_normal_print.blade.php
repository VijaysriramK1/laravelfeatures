    ...
    <div class="invoice">
        <div class="invoice_wrapper">
            ...
            <div class="{{ resultPrintStatus('body') ? 'meritTableBody' : 'meritTableBodyCustomReport' }}">
                ...
                <table
                    class="table border_table gray_header_table mb_30 max-width-400 ml_auto margin-auto report_table @if (resultPrintStatus('vertical_boarder')) mt_40 @endif">
                    <tbody>
                        <tr>
                        ...
                        @endif
                        <tr>
                            <td class="nowrap {{ generalSetting()->result_type == 'mark' ? 'text-center' : '' }}"
                                colspan="{{ generalSetting()->result_type == 'mark' ? '2' : '' }}">@lang('reports.average_mark')
                            </td>
