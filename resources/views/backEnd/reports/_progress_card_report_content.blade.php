                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-8 col-sm-8  text-center">
                                                ...
                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                    {{ isset(generalSetting()->address) ? generalSetting()->address : 'SGA School Address' }}
                                                </p>
                                                <p class="text-white mb-0" style="font-size: 16px;">
                                                    @lang('common.email'):
                                        ...
                                        <div class="student_marks_table">
                                            <div class="row">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <p class="mb-0">
                                                                @lang('common.academic_year') : &nbsp;<span
                                                                    class="primary-color fw-500">{{ @$studentDetails->academic->year }}</span>
                                                            </p>
                                                            <p class="mb-0">
                                                                @lang('common.class') :<span
                                                                    class="primary-color fw-500">{{ $studentDetails->class->class_name }}</span>
                                                            </p>
                                                            <p class="mb-0">
                                                                @lang('common.section') : <span
                                                                    class="primary-color fw-500">{{ $studentDetails->section->section_name }}</span>
                                                            </p>
                                                            <p class="mb-0">
                                                                @lang('student.admission_no') : <span
                                                                    class="primary-color fw-500">{{ $studentDetails->studentDetail->admission_no }}</span>
                                                            </p>
                                                            <p class="mb-0">
                                                                @lang('student.roll') :<span
                                                                    class="primary-color fw-500">{{ $studentDetails->roll_no }}</span>
                                                            </p>
                                                            <p class="mb-0">
                                                                @lang('common.date_of_birth') :<span
                                                                    class="primary-color fw-500">{{ $studentDetails->studentDetail->date_of_birth != '' ? dateConvert($studentDetails->studentDetail->date_of_birth) : '' }}</span>
                                                            </p>
                                                ...
                                                <div class="col-12 text-center mb-3">
                                                    <h3> <span
                                                            style="border-bottom: 3px double;">@lang('reports.progress_report')</span>
                                                    </h3>
                                                </div>
                                                        ...
                                                        <thead>
                                                            <tr class="text-center">
                                                                ...
                                                                @foreach ($assinged_exam_types as $assinged_exam_type)
                                                                    ...
                                                                    @endphp
                                                                    <th
                                                                        colspan="{{ @generalSetting()->result_type == 'mark' ? 2 : 4 }}">
                                                                        {{ $exam_type->title }}</th>
                                                                @endforeach
                                                            ...
                                                            if($result->count() > 0){
                                                                ?>
                                                                    ...
                                                                    @if (@generalSetting()->result_type != 'mark')
                                                                        ...
                                                                        <td>{{ number_format($final_results->total_gpa_point, 2, '.', '') }}
                                                                        </td>
                                                                    @endif
                                                                    <?php
                                                            }else{ ?>
                                                                ...
                                                                @foreach ($assinged_exam_types as $assinged_exam_type)
                                                                    ...
                                                                    @if (@generalSetting()->result_type != 'mark')
                                                                        <th colspan="4"> @lang('reports.average_gpa') :
                                                                            ...
                                                                            @lang('exam.position') :
                                                                            {{ getStudentMeritPosition($class_id, $section_id, $assinged_exam_type, $studentDetails->id) ?? 'null' }}
                                                                            @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                                                <hr>
                                                ...
                                                <table style="max-width: 400px; margin-bottom: 20px;"
                                                    class="table border_table gray_header_table mb_30 max-width-400 ml-auto mr-auto report_table  @if (resultPrintStatus('vertical_boarder')) mt-5 @endif">
                                                    <tbody>
                                                        {{-- Total Marks Start --}}
                                                        <tr>
                                                            <td colspan="{{ $colspan / $col_for_result - 1 }}">
                                                                @lang('exam.total_marks')</td>
                                                            @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                                <td colspan="{{ $colspan / $col_for_result + 7 }}"
                                                                    style="padding:10px; font-weight:bold">
                                                                    {{ $total_marks }} @lang('reports.out_of')
                                                                    {{ $all_exam_type_full_mark }}</td>
                                                            @else
                                                        ...
                                                        @if (@generalSetting()->result_type != 'mark')
                                                            ...
                                                            <tr>
                                                                ...
                                                                @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                                    ...
                                                                    <td colspan="3" style="padding:10px;">
                                                                        @lang('reports.without_additional_gpa')</td>
                                                            ...
                                                            <tr>
                                                                <td colspan="{{ $colspan / $col_for_result - 1 }}">
                                                                    @lang('exam.total_grade')</td>
                                                                @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                                    <td colspan="4" style="padding:10px;">
                                                                        {{ number_format($total_with_optional_percentage, 2, '.', '') }}
                                                                    </td>
                                                                    <td colspan="3" style="padding:10px;">
                                                                        @lang('reports.without_additional_grade')</td>
                                                                    <td colspan="2" style="padding:10px;">
                                                                        {{ number_format($with_percent_average_gpa, 2, '.', '') }}
                                                                    </td>
                                                                @else
                                                            ...
                                                            <tr>
                                                                @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                                    <td
                                                                        colspan="{{ $colspan / $col_for_result - 1 }}">
                                                                        @lang('reports.remarks')</td>
                                                                    <td colspan="{{ $colspan / $col_for_result + 7 }}"
                                                                        style="padding:10px; font-weight:bold">
