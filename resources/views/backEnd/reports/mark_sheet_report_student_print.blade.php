...
<body>
    <div class="invoice_wrapper">
        ...
        <div class="{{ resultPrintStatus('body') ? 'meritTableBody' : 'meritTableBodyCustomReport' }}">
                ...
                <tbody>
                    ...
                    @if (@$optional_subject_setup->gpa_above)
                        ...
                        @foreach ($mark_sheet as $data)
                            ...
                            <tr>
                                <td>{{ $data->subject->subject_name }}</td>
                                <td>{{ @subjectFullMark($exam_details->id, $data->subject->id, $class_id, $section_id) }}
                                </td>
                                <td>{{ @subjectHighestMark($exam_type_id, $data->subject->id, $class_id, $section_id) }}
                                </td>
                                <td>{{ @$data->total_marks }}
                                    @php
                                        if (@$generalsettingsResultType == 'mark') {
            ...
            <table
                class="table border_table gray_header_table mb_30 max-width-500 ml_auto margin-auto report_table @if (resultPrintStatus('vertical_boarder')) mt_40 @endif">
                <tbody>
                    <tr>
                        <td class="nowrap">@lang('exam.attendance')</td>
                        @if (isset($exam_content))
                            <td class="nowrap">{{ @$student_attendance }} @lang('exam.of') {{ @$total_class_days }}
                            </td>
                        @else
                    ...
                    <tr>
                        <td class="nowrap {{ $generalsettingsResultType == 'mark' ? 'text-center' : '' }}"
                            colspan="{{ $generalsettingsResultType == 'mark' ? '2' : '' }}">@lang('exam.average_mark')</td>
                    ...
                    @if (@$generalsettingsResultType != 'mark')
                        ...
                        <tr>
                            ...
                            <td colspan="2" style="text-align: center">
                                {{ getStudentMeritPosition($class_id, $section_id, $exam_details->id, $student_detail->id) }}
                            </td>
                        </tr>
                    @endif
                </tbody>
                        ...
                        font-size: 12px;">
                            ...
                            <td class="border-0">
                                <div class="text-right d-flex flex-column justify-content-end">
                                    ...
                                    <p
                                        style="text-align:right; float:right; display:inline-block; font-size: 12px; margin-top:5px; color: #000;">
                                        ({{ @$exam_content->title }})
                                    </p>
                                </div>
                            </td>
