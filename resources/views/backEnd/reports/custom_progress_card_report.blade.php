                                        ...
                                        <div class="single-report-admit">
                                            <div class="card">
                                                <div class="card-header">
                                                    <div class="d-flex">
                                                        ...
                                                        <div class="col-lg-6 ml-30">
                                                            ...
                                                            <p class="text-white mb-0">
                                                                @lang('common.email'):
                                                                {{ isset($email) ? $email : 'admin@demo.com' }} ,
                                                                @lang('common.phone'):
                                                ...
                                                <div class="card-body">
                                                    <div class="row justify-content-between">
                                                        <div class="col-lg-7 text-black">
                                                            <h3
                                                                ...
                                                                @lang('exam.student_information')</h3>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <p class="mb-0"> @lang('student.admission_no'):
                                                                        <span class="primary-color fw-500">
                                                                            {{ $studentDetails->admission_no }}</span>
                                                                    </p>
                                                                </div>
                                                                <div class="col-lg-3">
                                                        ...
                                                        <div class="col-lg-4 text-black">
                                                            @php
                                                                $marks_grade = DB::table('sm_marks_grades')->where('academic_id', getAcademicId())->get();
                                                            @endphp
                                                            @if (@$marks_grade)
                                                                <table
                                                    ...
                                                    <div>
                                                        <h3 class="primary-color fw-500 text-center">@lang('exam.progress_card')
                                                        </h3>
                                                        {{-- Start Test --}}
                                                                ...
                                                                <table class="custom_table">
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            @foreach ($assigned_exam as $key => $item)
                                                                                ...
                                                                                @endif
                                                                                <th
                                                                                    colspan={{ $assign_subjects->count() * 2 + 1 }}width">
                                                                                    {{ $item->title }}
                                                                                    {{ $percentage }}% </th>
                                                                            @endforeach

                                                                            <th colspan="{{ $assign_subjects->count() * 2 + 1 }}"
                                                                                class="full_width">@lang('reports.result')</th>
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @endforeach
                                                                            <td rowspan="2">
                                                                                {{ number_format((float) $final_result, 2, '.', '') }}
                                                                            </td>
                                                                        </tr>
