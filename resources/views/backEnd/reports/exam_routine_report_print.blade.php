        ...
        <table cellspacing="0" width="100%">
            <tr>
                ...
                <td>
                    ...
                    <span style="font-size:14px !important;" align="left" class="text-white">@lang('common.academic_year') :
                        {{ @$academic_year->title }} ({{ @$academic_year->year }}) </span>
                </td>
                ...
                @foreach ($exam_schedules as $item)
                    <tr>
                        <td>{{ dateConvert($item->date) }}
                            <br>{{ Carbon::createFromFormat('Y-m-d', $item->date)->format('l') }}</td>
                        <td>
