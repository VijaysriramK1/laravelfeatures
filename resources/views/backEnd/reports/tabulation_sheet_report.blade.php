                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        @includeIf(
                                            ...
                                            ['required' => ['USN', 'UD', 'UA', 'US', 'USL'], 'hide' => ['USUB']]
                                        )
                            ...
                            @else
                                ...
                                <div class="col-lg-3 mt-30-md md_mb_20" id="select_section_div">
                                    <label class="primary_input_label" for="">{{ __('common.section') }}<span
                                            class="text-danger"> *</span></label>
                                    <select
                                ...
                                <div class="col-lg-3 mt-30-md md_mb_20" id="select_student_div">
                                    <label class="primary_input_label"
                                        for="">{{ __('common.student') }}<span></span></label>
                                    <select
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8 pull-right mt-0">
                                    <div class="print_button pull-right">
                                        ...
                                        @endif
                                        <button type="submit" class="primary-btn small fix-gr-bg"><i class="ti-printer">
                                            </i> @lang('common.print')</button>
                                        {{ Form::close() }}
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="card-header">
                                            <div class="row align-items-center">
                                                ...
                                                <div class=" col-lg-8 text-left text-lg-right mt-30-md">
                                                    <h3 class="text-white">
                                                        {{ isset(generalSetting()->school_name) ? generalSetting()->school_name : 'SGA School Management ERP' }}
                                                    </h3>
                                                    <p class="text-white mb-0">
                                                        {{ isset(generalSetting()->address) ? generalSetting()->address : 'SGA School Adress' }}
                                                    </p>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="white-box">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h4 class="exam_title text-center text-uppercase"> @lang('reports.tabulation_sheet_of')
                                                    {{ $tabulation_details['exam_term'] }} @lang('reports.in')
                                                    {{ $year }}</h4>
                                                <hr>
                                                <br>
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <ul class="student_info">
                                                            <li>
                                                                ...
                                                                <p class="bold_text">:
                                                                    {{ $tabulation_details['student_name'] }}</p>
                                                            </li>
                                                            <li>
                                                                <p>@lang('common.class')</p>
                                                                <p class="bold_text">:
                                                                    {{ $tabulation_details['student_class'] }}</p>
                                                            </li>
                                                            <li>
                                                                <p>@lang('common.section')</p>
                                                                <p class="bold_text">:
                                                                    {{ $tabulation_details['student_section'] }}</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <ul class="student_info info2">
                                                            <li>
                                                                ...
                                                                <p class="bold_text">:
                                                                    {{ $tabulation_details['student_roll'] }}</p>
                                                            </li>
                                                            <li>
                                                                <p>@lang('student.admission_no')</p>
                                                                <p class="bold_text">:
                                                                    {{ $tabulation_details['student_admission_no'] }}</p>
                                                            </li>
                                                            <li>
                                                                <p>@lang('exam.exam')</p>
                                                                <p class="bold_text">:
                                                                    {{ $tabulation_details['exam_term'] }}</p>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="single-report-admit mt-50">
                                            <div class="student_marks_table pt-0 mt-0">
                                                <div class="table-responsive">
                                                    <table
                                                        class="mt-0 mb-20 table table-striped table-bordered scrolled_table">
                                                        <thead>
                                                            <tr>
                                                                @foreach ($subjects as $subject)
                                                                    ...
                                                                    @endphp
                                                                    <th colspan="{{ count($mark_parts) + 1 }}"
                                                                        class="subject-list large_spanTh">
                                                                        {{ $subject_Name }}</th>
                                                                @endforeach
                                                                <th rowspan="2" class="large_spanTh">@lang('exam.total_mark')
                                                                </th>
                                                                @if ($optional_subject_setup != '')
                                                                    @if (@generalSetting()->result_type != 'mark')
                                                                        <th class="large_spanTh">@lang('exam.gpa')</th>
                                                                        <th rowspan="2" class="large_spanTh">
                                                                            @lang('exam.gpa')</th>
                                                                        <th rowspan="2" class="large_spanTh">
                                                                            @lang('reports.result')</th>
                                                                    @endif
                                                                @else
                                                                    @if (@generalSetting()->result_type != 'mark')
                                                                        <th rowspan="2" class="large_spanTh">
                                                                    ...
                                                                    @endif
                                                                @endif
                                                                <th rowspan="2" class="large_spanTh">@lang('exam.position')
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                @foreach ($subjects as $subject)
                                                                    ...
                                                                    @foreach ($mark_parts as $sigle_part)
                                                                        <th class="large_padding">
                                                                            {{ $sigle_part->exam_title }}
                                                                            ({{ $sigle_part->exam_mark }})</th>
                                                                    @endforeach
                                                                ...
                                                                @if ($optional_subject_setup != '')
                                                                    <th class="large_padding">
                                                                        <small>@lang('reports.without_additional')</small></th>
                                                                @endif
                                                                    ...
                                                                    @else
                                                                        @if (@generalSetting()->result_type != 'mark')
                                                                            ...
                                                                            <td>
                                                                                @if (isset($this_student_failed) && $this_student_failed == 1)
                                                                                    <span
                                                                                        class="text-dander font-weight-bold">
                                                                                    </span>
                                                                                @else
                                                                                    @php
                                                                                        $main_subject_total_gpa = 0;
                                                ...
                                                @if ($examReportSignature->count() > 1 || !$exam_content)
                                                    <div
                                                        style="margin-top:auto; margin-bottom:20px; display: flex; justify-content: {{ $examReportSignature->count() == 1 ? 'flex-end' : 'space-between' }}; flex-wrap: wrap; align-items: center;">
                                                        @foreach ($examReportSignature as $signature)
                                                            <div
                                                                style="text-align: right; display: flex; align-items: center; justify-content: center; margin-right: 24px; flex-direction: column">
                                                                <div>
                                                                    <img src="{{ asset($signature->signature) }}"
                                                                        width="150px" height="40px"
                                                                        alt="{{ $signature->title }}">
                                                                </div>
                                                                <p
                                                                    style="margin-top:8px; text-align: center; width: 100%; border-top: 1px solid rgba(67, 89, 187, 0.15) !important">
                                                                    {{ $signature->title }}
                                                                </p>
                                                            </div>
                                                        @endforeach
                                                ...
                                                @if ($exam_content)
                                                    <table
                                                        style="width:100%;  @if ($examReportSignature->count() > 1) border-top: 1px solid #000 !important; @else  margin-top: auto; @endif"
                                                                    ...
                                                                    @if ($examReportSignature->count() == 1)
                                                                        <div
                                                                            ...
                                                                            <div class="thumb text-right">
                                                                                <img src="{{ asset(@$examReportSignature->first()->signature) }}"
                                                                                    width="100px">
                                                                            </div>
                                                                            <p
                                    ...
                                    <div class="single-report-admit">
                                        <div class="card-header">
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-lg-4">
                                                    <h3 class="text-white">@lang('common.class') :
                                                        {{ $tabulation_details['class'] }}</h3>
                                                    <p class="text-white mb-0">@lang('common.section') :
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <h4 class="exam_title text-center text-uppercase">
                                                    @lang('reports.tabulation_sheet_of') {{ $tabulation_details['exam_term'] }}
                                                    @lang('reports.in') {{ $year }}
                                                </h4>
                                                <br>
                                                <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="single-report-admit">
                                                    <div class="student_marks_table pt-0">
                                                        <div class="table-responsive">
                                                            <table
                                                                class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                                <thead>
                                                                    <tr>
                                                                        <th class="name_field" rowspan="2">
                                                                            @lang('common.name')</th>
                                                                        <th class="roll_field" rowspan="2">
                                                                            @lang('student.roll_no')</th>
                                                                        @foreach ($subjects as $subject)
                                                                            @php
                                                                                $subject_ID = $subject->subject_id;
                                                                                $subject_Name = $subject->subject->subject_name;
                                                                                $mark_parts = App\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id);
                                                                            @endphp
                                                                            <th class="large_spanTh"
                                                                                colspan="{{ count($mark_parts) + 1 }}">
                                                                                {{ $subject_Name }}</th>
                                                                        @endforeach
                                                                        <th class="large_spanTh" rowspan="2"
                                                                            colspan="1">@lang('exam.total_mark')</th>
                                                                        @if ($optional_subject_setup != '')
                                                                            <th class="large_spanTh">@lang('exam.gpa')
                                                                            </th>
                                                                            <th rowspan="2" class="large_spanTh">
                                                                                @lang('exam.gpa')</th>
                                                                            <th rowspan="2" class="large_spanTh">
