...
<head>
    ...
    <style>
        ...
        .gray_header_table tbody td,
        .gray_header_table tbody th {
            border-bottom: 1px solid #000 !important;
            text-align: left;
        }
        ...
        .custom_result_print h3,
        .custom_result_print h5 {
            color: black;
        }
        ...
        <div class="invoice_wrapper">
                    ...
                    <div class="invoice_part_iner">
                        <table class="table border_bottom mb-0">
                            <thead>
                                <td style="padding: 0">
                                    <div
                                        class="{{ resultPrintStatus('header') ? 'logo_img' : 'logo_img custom_result_print' }}">
                                        <div class="thumb_logo">
                                            <img src="{{ asset('/') }}{{ generalSetting()->logo }}"
                                                alt="{{ generalSetting()->school_name }}">
                                        </div>
                                        <div class="company_info">
                                            <h3>{{ isset(generalSetting()->school_name) ? generalSetting()->school_name : 'SGA School Management ERP' }}
                                            </h3>
                                            <h5>{{ isset(generalSetting()->address) ? generalSetting()->address : 'SGA School Address' }}
                                            </h5>
                                            <h5>
                                                @lang('common.email'):
                                                {{ isset(generalSetting()->email) ? generalSetting()->email : 'admin@example.com' }}
                                                @lang('common.phone'):
                                        ...
                                        @if (resultPrintStatus('image'))
                                            <div class="profile_thumb">
                                                <img src="{{ file_exists(@$student_detail->studentDetail->student_photo) ? asset($student_detail->studentDetail->student_photo) : asset('public/uploads/staff/demo/staff.jpg') }}"
                                                    alt="{{ $student_detail->studentDetail->full_name }}"
            ...
            <div class="{{ resultPrintStatus('body') ? 'meritTableBody' : 'meritTableBodyCustomReport' }}">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                @if (@$marks_grade)
                                    <table
                                        class="table border_table gray_header_table max-width-400 ml_auto gradeTable_minimal"
                    ...
                    <thead>
                        <tr>
                            ...
                            @foreach ($assinged_exam_types as $assinged_exam_type)
                                ...
                                @endphp
                                <th colspan="{{ @generalSetting()->result_type == 'mark' ? 2 : 4 }}">
                                    {{ $exam_type->title }}</th>
                            @endforeach
                                ...
                                @if (@generalSetting()->result_type != 'mark')
                                    <td colspan="4">
                                        <strong>
                                            ...
                                            @lang('exam.position') :
                                            {{ getStudentMeritPosition($class_id, $section_id, $assinged_exam_type, $student_id) ?? 'null' }}
                                            @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                <hr>
                ...
                <table class="table border_table gray_header_table max-width-400 ml_auto margin-auto report_table"
                    style="@if (resultPrintStatus('vertical_boarder')) margin-top: 20px; @endif margin-bottom: 20px;">
                    <tbody>
                        <tr>
