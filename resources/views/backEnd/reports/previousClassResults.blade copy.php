...
<section class="admin-visitor-area">
    ...
    <div class="row">
        ...
        <div class="offset-lg-10 col-lg-2 pull-right text-right mt-20 ">
            <a target="_blank" href="{{route('session_student_print',$admission_number  )}}" class="primary-btn small fix-gr-bg "><span class="ti-printer pr-2"></span> @lang('common.print') </a>
        </div>
    </div>
    <div class="row mt-20">
        <div class="col-lg-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex">
                                        ...
                                        <div class="ml-30">
                                            <h3 class="text-white"> {{isset(generalSetting()->school_name)? generalSetting()->school_name :'SGA School Management ERP'}} </h3>
                                            <p class="text-white mb-0"> {{isset(generalSetting()->address)?generalSetting()->address:'SGA School Address'}} </p>
                                        </div>
                                    </div>
                                    <div>
                                        <img class="logo-img" src="{{ $generalSetting->logo }}" alt="">
