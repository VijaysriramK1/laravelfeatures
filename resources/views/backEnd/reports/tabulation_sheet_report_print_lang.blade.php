                        ...
                        <tr>
                            @foreach ($subjects as $subject)
                                ...
                                @php
                                    ...
                                    $mark_grade = App\SmMarksGrade::where([['percent_from', '<=', $persentage], ['percent_upto', '>=', $persentage]])
            ...
            <div class="invoice_print mb_30">
                <div class="container">
                    <div class="invoice_part_iner">
                                                ...
                                                <div class="container">
                                                    <div class="invoice_part_iner">
                                                                ...
                                                                <td>
                                                                    <div class="logo_img">
                                                                        <div class="logo_thumb_upper">
                                                                            ...
                                                                            <h2>
                                                                                @lang('common.class') :
                                                                                {{ $tabulation_details['class'] }}
                                                                                <br>
                                                                                <p>@lang('common.section') :
                                                                                    {{ $tabulation_details['section'] }}
                                                                                </p>
                                                                            </h2>
                                                                        </div>
                                                                        <div class="company_info">
                                                        ...
                                                        <div class="table_title"
                                                            ...
                                                            <h3>
                                                                @lang('reports.tabulation_sheet_of')
                                                                {{ $tabulation_details['exam_term'] }}
                        ...
                        <div class="table_title" style="margin-bottom: 20px; text-align: center">
                            <h3>
                                @lang('exam.tabulation_sheet') @lang('exam.of') {{ $tabulation_details['exam_term'] }}
                                @lang('exam.in') {{ $year }}
                            </h3>
                        </div>
                        <table class="table border_table gray_header_table mb-0">
                                ...
                                <tr>
                                    ...
                                    @foreach ($subjects as $subject)
                                        @php
                                            ...
                                            $mark_parts = App\SmAssignSubject::getNumberOfPart($subject_ID, $class_id, $section_id, $exam_term_id);
                                        @endphp
                                        <th colspan="{{ count($mark_parts) + 1 }}" class="subject-list">
                                            {{ $subject_Name }}</th>
                                    @endforeach
                                    <th rowspan="2"> @lang('exam.total_mark')</th>
                                    @if ($optional_subject_setup != '')
