                            ...
                            <tbody>
                                <tr>
                                    <div class="table_title" style="margin-bottom: 20px; text-align: center">
                                        <h3>@lang('reports.tabulation_sheet_of') {{ $tabulation_details['exam_term'] }} @lang('reports.in')
                                            {{ $year }}</h3>
                                    </div>
                        ...
                        <tr>
                            ...
                            @if ($optional_subject_setup != '')
                                ...
                                <td>
                                    ...
                                    @if (isset($this_student_failed) && $this_student_failed == 1)
                                        <span
                                            class="text-warning font-weight-bold">{{ $fail_grade_name->grade_name }}</span>
                                    @else
                                        @php
                                            if ($number >= $max_grade) {
            ...
            <div class="invoice_print mb_30">
                <div class="container">
                    <div class="invoice_part_iner">
                        ...
                        <div class="table_title" style="margin-bottom: 20px; text-align: center">
                            <h3>
                                @lang('reports.tabulation_sheet_of') {{ $tabulation_details['exam_term'] }} @lang('reports.in')
                                {{ $year }}
                            </h3>
                        </div>
                    </div>
