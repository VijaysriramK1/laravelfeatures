                            ...
                            <select class="primary_select form-control{{ $errors->has('exam') ? ' is-invalid' : '' }}"
                                ...
                                @foreach ($exams as $exam)
                                    <option value="{{ $exam->id }}"
                                        {{ isset($exam_id) ? ($exam_id == $exam->id ? 'selected' : '') : '' }}>{{ $exam->name }}
                                    </option>
                                @endforeach
                            </select>
                            @if ($errors->has('exam'))
                                            ...
                                            <div class="card-header">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="ml-30">
                                                        ...
                                                        <p class="text-white mb-0">House 25, Road 27, Block B, 54th Floor,
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <p class="mb-0">
                                                                        Academic Year : <span
                                                                            class="primary-color fw-500">2018-19</span>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                        Exam : <span
                                                                            class="primary-color fw-500">{{ $exam->name }}</span>
                                                                    </p>
                                                                    <p class="mb-0">
                                                                        Class : <span
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($allresult_data as $row)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button
                                                                        class="primary-btn small bg-success text-white border-0">Pass</button>
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                    </tbody>
