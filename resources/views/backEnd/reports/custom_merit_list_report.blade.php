            ...
            <div class="container-fluid p-0">
                <div class="row mt-40">
                    ...
                    <div class="col-lg-8 pull-right">
                        <a href="{{ route('custom-merit-list-print', [$InputClassId, $InputSectionId]) }}"
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <div class="student_marks_table">
                                                        <table class="w-100 mt-30 mb-20 table table-bordered meritList">
                                                            <thead>
                                                                <tr>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('common.sl')</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('student.admission_no')</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('common.student')</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('exam.first_term')
                                                                        ({{ $custom_result_setup->percentage1 }}%)</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('exam.second_term')
                                                                        ({{ $custom_result_setup->percentage2 }}%)</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('exam.third_term')
                                                                        ({{ $custom_result_setup->percentage3 }}%)</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('exam.final_result')</th>
                                                                    <th colspan="" class="full_width">
                                                                        @lang('exam.grade')</th>
                                                                </tr>
                                                            </thead>
