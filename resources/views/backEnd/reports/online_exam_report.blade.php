                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($students as $student)
                                            ...
                                            <tr>
                                                ...
                                                @if (moduleStatusCheck('University'))
                                                    <td>{{ $student->studentRecord->unSemesterLabel ? $student->studentRecord->unSemesterLabel->name : '' }}
                                                        {{ $student->studentRecord->section ? '(' . $student->studentRecord->section->section_name . ')' : '' }}
                                                    </td>
                                                @else
                                                    <td>

                                                        @php
                                                            if (!empty($student->recordClass)) {
                                                                echo $student->recordClass->class->class_name;
                                                            } else {
                                                                echo '';
                                                            }
                                                        @endphp
                                                    ...
                                                    @if (in_array($student->id, $present_students))
                                                        @php
                                                            if (moduleStatusCheck('OnlineExam') == true) {
                                                                $obtained_marks = Modules\OnlineExam\Entities\SmaOnlineExam::obtainedMarks($online_exam_question->id, $student->id);
                                                            } else {
