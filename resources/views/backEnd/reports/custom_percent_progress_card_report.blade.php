                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 mt-30-md md_mb_20" id="select_student_div">
                            <select class="primary_select form-control{{ $errors->has('student') ? ' is-invalid' : '' }}"
                                ...
                                <option data-display="@lang('common.select_student') *" value="">@lang('common.select_student') *
                                </option>
                            </select>
                                                            ...
                                                            <table class="table mb-0 center-table">
                                                                <thead>
                                                                    <tr class="text-center">
                                                                        <th
                                                                            rowspan="{{ @generalSetting()->result_type == 'mark' ? '1' : '2' }}">
                                                                            @lang('common.subjects')</th>
                                                                        @foreach ($assinged_exam_types as $assinged_exam_type)
                                                                            @php
                                                                                $exam_type = App\SmExamType::examType($assinged_exam_type);
                                                                            @endphp
                                                                            <th
                                                                                colspan="{{ @generalSetting()->result_type == 'mark' ? 1 : 1 }}">
                                                                                {{ $exam_type->title }}</th>
                                                                        @endforeach
                                                                        <th
                                                                            rowspan="{{ @generalSetting()->result_type == 'mark' ? '1' : '2' }}">
                                                                        ...
                                                                        <th
                                                                            rowspan="{{ @generalSetting()->result_type == 'mark' ? '1' : '2' }}">
                                                                            @lang('exam.average')</th>
                                                                        <th
                                                                            rowspan="{{ @generalSetting()->result_type == 'mark' ? '1' : '2' }}">
                                                                            @lang('exam.letter_grade')</th>
                                                                    </tr>
                                                                    <tr class="text-center">
                                                                        @if (@generalSetting()->result_type == 'mark')
                                                                            <th rowspan="2"></th>
                                                                ...
                                                                @endif
                                                                        ...
                                                                        <tr>
                                                                            @if ($optional_subject_setup != '' && $student_optional_subject != '')
                                                                                ...
                                                                                <td
                                                                                    colspan="{{ $colspan / $col_for_result + 7 }}">
                                                                                    {{ remarks(number_format($total_with_optional_percentage, 2, '.', '')) }}
                                                                                </td>
                                                                            @else
                                                                                <td
                                                                                ...
                                                                                <td
                                                                                    colspan="{{ $colspan / $col_for_result + 9 }}">
