                    ...
                    <div class="white-box">
                        <div class="">
                            ...
                            <div class="row mb-20">
                                ...
                                @endif
                                <div class="col-lg-3">
                                    <label class="primary_input_label" for="">@lang('student.admission_date')<span class="text-danger"> *</span></label>
                                    <input class="primary_input_field form-control" type="date" name="admission_date" value="{{ $student->admission_date}}">
                                </div>
                            </div>
                            <div class="row mb-20">
