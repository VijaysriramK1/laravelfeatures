                    ...
                    <div class="white-box">
                        <ul class="nav nav-tabs tabs_scroll_nav mb-10" role="tablist">
                                ...
                                @if (userPermission('student-apply-leave'))
                                    <li class="nav-item">
                                        <a class="nav-link" href="#leaves" role="tab"
                                            data-toggle="tab">@lang('leave.leave')</a>
                                    </li>
                                @endif
                                    ...
                                    @if (userPermission('wallet.my-wallet'))
                                        <li class="nav-item">
                                            <a class="nav-link {{ Session::get('studentWallet') == 'active' ? 'active' : '' }} "
                                                href="#studentWallet" role="tab" data-toggle="tab">
                                                @lang('wallet::wallet.wallet')</a>
                                        </li>
                                    @endif
                                @endif
                            ...
                            @else
                                @if (generalSetting()->fees_status == 0)
                                    @if (userPermission('student-profile.fees'))
                                        <li class="nav-item disabled-cls">
                                            <a class="nav-link" href="#studentFees" role="tab"
                                                data-toggle="tab">@lang('fees.fees')</a>
                                        </li>
                                    @endif
                                ...
                                @if (userPermission('student-profile.document'))
                                    <li class="nav-item disabled-cls">
                                        <a class="nav-link {{ Session::get('studentDocuments') == 'active' ? 'active' : '' }}"
                                            href="#studentDocuments" role="tab"
                                ...
                                @if (userPermission('studentTimeline'))
                                    <li class="nav-item disabled-cls">
                                        <a class="nav-link {{ Session::get('studentTimeline') == 'active' ? 'active' : '' }} "
                                            href="#studentTimeline" role="tab"
                                            data-toggle="tab">@lang('student.record')</a>
                                    </li>
                                @endif
                                            ...
                                            <div class="row">
                                                ...
                                                @if (moduleStatusCheck('University'))
                                                    <div class="col-lg-8 mb-10">
                                                        <table
                                                            class="table school-table-style res_scrol school-table-up-style"
                                                            ...
                                                            <tbody>
                                                                @foreach ($record->fees as $assign_fees)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>{{ dateConvert($assign_fees->created_at) }}
                                                                        </td>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        @foreach ($fees_assigneds as $fees_assigned)
                                                            @if ($fees_assigned->record_id == $record->id)
                                                                @php
                                                                    @$grand_total += @$fees_assigned->feesGroupMaster
                                                                        ->amount;
                                                                ...
                                                                @php
                                                                    @$discount_amount =
                                                                        $fees_assigned->applied_discount;
                                                                    @$total_discount += @$discount_amount;
                                                                    @$student_id = @$fees_assigned->student_id;
                                                                @endphp
                                                                @php
                                                                    @$paid = App\SmFeesAssign::discountSum(
                                                                        @$fees_assigned->student_id,
                                                                        @$fees_assigned->feesGroupMaster->feesTypes->id,
                                                                        'amount',
                                                                ...
                                                                @endphp
                                                                @php
                                                                    @$fine = App\SmFeesAssign::discountSum(
                                                                        @$fees_assigned->student_id,
                                                                        @$fees_assigned->feesGroupMaster->feesTypes->id,
                                                                        'fine',
                                                                        $fees_assigned->record_id,
                                                                ...
                                                                @php
                                                                    @$payments = App\SmFeesAssign::feesPayment(
                                                                        @$fees_assigned->feesGroupMaster->feesTypes->id,
                                                                        @$fees_assigned->student_id,
                                                                        $fees_assigned->recordDetail->id,
                                                                    );
                                                                    $i = 0;
                                                                @endphp
                                                        ...
                                                        <table id="table_id" class="table" cellspacing="0" width="100%">
                                                            ...
                                                            <tbody>
                                                                @foreach ($get_results as $mark)
                                                                    @php
                                                                        if (
                                                                            !is_null($optional_subject_setup) &&
                                                                            !is_null($student_optional_subject)
                                                                        ) {
                                                                            if (
                                                                                $mark->subject_id !=
                                                                                @$student_optional_subject->subject_id
                                                                            ) {
                                                                        ...
                                                                        $get_subject_marks = subjectFullMark(
                                                                            $mark->exam_type_id,
                                                                            $mark->subject_id,
                                                                            $mark->studentRecord->class_id,
                                                                            $mark->studentRecord->section_id,
                                                                        );

                                                                        $subject_marks = App\SmStudent::fullMarksBySubject(
                                                                            $exam->id,
                                                                            $mark->subject_id,
                                                                        );
                                                                        $schedule_by_subject = App\SmStudent::scheduleBySubject(
                                                                            $exam->id,
                                                                            $mark->subject_id,
                                                                            @$record,
                                                                        );
                                                                        $result_subject = 0;
                                                                        if (
                                                                            @generalSetting()->result_type == 'mark'
                                                                        ) {
                                                                        ...
                                                                        if (@$mark->is_absent == 0) {
                                                                            ...
                                                                            if (
                                                                                $mark->marks < $subject_marks->pass_mark
                                                                            ) {
                                                                                $result_subject++;
                                                                                $result++;
                                                                            }
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        @if (@generalSetting()->result_type == 'mark')
                                                                            <td>
                                                                                @php
                                                                                    $totalMark = subjectPercentageMark(
                                                                                        @$mark->total_marks,
                                                                                        @subjectFullMark($mark->exam_type_id, $mark->subject_id, $mark->studentRecord->class_id, $mark->studentRecord->section_id),
                                                                                    );
                                                                                    $passMark =
                                                                                        $mark->subject->pass_mark;
                                                                                @endphp
                                                                    ...
                                                                    @else
                                                                            ...
                                                                            @php
                                                                                if (
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        if ($gpa_point >= $maxgpa) {
                                                                                            $average_grade_max = App\SmMarksGrade::where(
                                                                                                'school_id',
                                                                                                Auth::user()->school_id,
                                                                                            )
                                                                                                ->where(
                                                                        ...
                                                                        <th>
                                                                            ...
                                                                            @php
                                                                                $final_gpa_point = 0;
                                                                                $final_gpa_point =
                                                                                    ($total_gpa_point - $optional_gpa) /
                                                                                    ($total_subject -
                                                                                        $optional_subject);
                                                                                $float_final_gpa_point = number_format(
                                                                                    $final_gpa_point,
                                                                                    2,
                                                                                );
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @php
                                                        $total_marks = 0;
                                                        foreach (
                                                            $result_view->onlineExam->assignQuestions
                                                            as $assignQuestion
                                                        ) {
                                                            @$total_marks =
                                                ...
                                                <td>
                                                    @php
                                                        $startTime = strtotime(
                                                            $result_view->onlineExam->date .
                                                                ' ' .
                                                                $result_view->onlineExam->start_time,
                                                        );
                                                        $endTime = strtotime(
                                                            $result_view->onlineExam->date .
                                                                ' ' .
                                                                $result_view->onlineExam->end_time,
                                                        );
                                                        $now = date('h:i:s');
                                                        $now = strtotime('now');
                                                    @endphp
                                                    @if ($now >= $endTime)
                                                        <a class="btn btn-success modalLink" data-modal-size="modal-lg"
                                                            title="Answer Script"
                                                            href="
                                                        ...
                                                        <td>
                                                            @if (file_exists($student_detail->document_file_1))
                                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                                    href="{{ url($student_detail->document_file_1) }}"
                                                                    download>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (file_exists($student_detail->document_file_2))
                                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                                    href="{{ url($student_detail->document_file_2) }}"
                                                                    download>
                                                                    @lang('common.download')<span class="pl ti-download"></span>
                                                                </a>
                                                                <a class="primary-btn icon-only fix-gr-bg"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (file_exists($student_detail->document_file_3))
                                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                                    href="{{ url($student_detail->document_file_3) }}"
                                                                    download>
                                                                    @lang('common.download')<span class="pl ti-download"></span>
                                                                </a>
                                                                <a class="primary-btn icon-only fix-gr-bg"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @if (file_exists($student_detail->document_file_4))
                                                                <a class="primary-btn tr-bg text-uppercase bord-rad"
                                                                    href="{{ url($student_detail->document_file_4) }}"
                                                                    download>
                                                                    @lang('common.download')<span class="pl ti-download"></span>
                                                                </a>
