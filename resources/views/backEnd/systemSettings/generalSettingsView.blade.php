                            ...
                            <div class="white-box">
                                ...
                                <div class="text-center">
                                    ...
                                    @if (isset($editData->logo))
                                        <img id="upload_logo_preview" class="img-fluid Img-100"
                                            src="{{ asset($editData->logo) }}" alt="">
                                    @else
                                        <img id="upload_logo_preview" class="img-fluid"
                                            src="{{ asset('public/uploads/settings/logo.png') }}" alt="">
                                    @endif
                                </div>
                                ...
                                <div class="mt-40">
                                    <div class="text-center">
                                        <label class="primary-btn small fix-gr-bg"
                                            for="upload_logo">@lang('system_settings.upload')</label>
                                    ...
                                    @if (Illuminate\Support\Facades\Config::get('app.app_sync'))
                                        <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                            title="Disabled For Demo "> <button
                                                class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;"
                                                type="button">@lang('system_settings.change_logo')</button></span>
                                    @else
                                        @if (userPermission('update-school-logo'))
                            ...
                            <div class="white-box">
                                ...
                                <div class="text-center">
                                    @if (isset($editData->favicon) && !empty(@$editData->favicon))
                                        <img id="upload_favicon_preview" class="img-fluid Img-50"
                                            src="{{ @$editData->favicon }}" alt="">
                                    @else
                                        <img id="upload_favicon_preview" class="img-fluid"
                                            src="{{ asset('public/uploads/settings/favicon.png') }}" alt="">
                                    @endif
                                </div>
                                ...
                                <div class="mt-40">
                                    <div class="text-center">
                                        <label class="primary-btn small fix-gr-bg"
                                            for="upload_favicon">@lang('system_settings.upload')</label>
                                ...
                                <div class="col-lg-12 text-center">
                                    @if (Illuminate\Support\Facades\Config::get('app.app_sync'))
                                        <span class="d-inline-block" tabindex="0" data-toggle="tooltip"
                                            title="Disabled For Demo "> <button
                                                class="primary-btn small fix-gr-bg  demo_view" style="pointer-events: none;"
                                                type="button">@lang('system_settings.change_fav')</button></span>
                                    @else
                                ...
                                <div class="row xm_3">
                                    ...
                                    <div class=" col-lg-5 col-xl-5 text-right col-md-6 col-sm-6 sm2_10">
                                        @if (userPermission('update-general-settings'))
                                            <a href="{{ route('update-general-settings') }}"
                                                class="primary-btn small fix-gr-bg "> <span class="ti-pencil-alt"></span>
                                                @lang('common.edit')
                                            </a>
                                        @endif
                                    </div>
                                ...
                                <div class="student-meta-box">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="value text-left">
                                                    ...
                                                    @if (moduleStatusCheck('University'))
                                                        {{ @$editData->unAcademic->name }} [
                                                        {{ @dateConvert($editData->unAcademic->start_date) }} -
                                                        {{ @dateConvert($editData->unAcademic->end_date) }} ]
                                                    @else
                                    ...
                                    <div class="single-meta">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="name">
                                                    @lang('admin.student_badge')
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="value text-left">
                                                    @if (isset($editData))
                                                        @if (@$editData->badge_system != '' && @$editData->badge_system == 1)
                                                            {{ __('common.enable') }}
                                                        @else
                                                            {{ __('common.disable') }}
                                                        @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="value text-left">
                                                    ...
                                                    @else
                                                        Copyright 2019 All rights reserved by SG Academy
                                                    @endif
                                                </div>
                                            </div>
                                        </div>
