                                ...
                                <div class="add-visitor">
                                    ...
                                    <div class="primary_input">
                                        <div class="primary_file_uploader">
                                            <input
                                                class="primary_input_field form-control {{ $errors->has('updateFile') ? ' is-invalid' : '' }}"
                                                readonly="true" type="text"
                                                placeholder="{{ isset($editData->file) && @$editData->file != '' ? getFilePath3(@$editData->file) : 'Upload File' }} "
                                                id="placeholderInputUpdate" name="updateFile">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                    for="upload_update_file">@lang('common.browse')</label>
                                    ...
                                    <div class="add-visitor">
                                        <table style="width:100%; box-shadow: none;" class="table school-table-style">
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="https://sgupdate.test" target="_blank"> <i
                                                            class="ti-new-window"> </i> Update </a> </td>
                                            </tr>
                                            <tr>
