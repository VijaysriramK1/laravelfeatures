        ...
        <table cellspacing="0" width="100%">
            <tr>
                ...
                <td style="text-aligh:left">
                    ...
                    <span style="font-size:11px !important;" align="left" class="text-white">@lang('common.academic_year'):
                        {{ @$academic_year->title }}
                ...
                <td style="text-aligh:center">
                    ...
                    <span style="font-size:11px !important;margin:0px" class="text-white ">
