        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="#">@lang('notification.notifications')</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="white-box">
                        <div class="main-title">
                            <h3 class="mb-15">@lang('notification.notification_list')</h3>
                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-grow-1">
                                            ...
                                            <a href="{{ @$notification->url }}"
                                                class="notification_view_details">@lang('notification.view_details')</a>
                                        </div>
                                        <div>
