                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('common.description')
                                                    <span></span></label>
                                                <textarea class="primary_input_field form-control" cols="0" rows="4" name="description">{{ isset($admin_setup) ? $admin_setup->description : '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    @php
                                                                            ...
                                                                            <li>
                                                                                <div class="module_link_option_div"
                                                                                    ...
                                                                                    <div class="dropdown p-2">
                                                                                        <button type="button"
                                                                                            class="btn dropdown-toggle sma_csk module_id_ module_option_ module_link_option"
