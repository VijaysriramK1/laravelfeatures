<div id="horizontal" class="{{ $id_card->page_layout_style == 'horizontal' ? 'd-block' : 'd-none' }}"
    ...
    <div class="horizontal__card"
        ...
        <div class="horizontal_card_header"
            ...
            <div class="logo__img logoImage hLogo"
                style="line-height:1.02; width: 80px; background-image: url({{ $id_card->logo != '' ? asset($id_card->logo) : asset(generalSetting()->logo) }});height: 30px; background-size: cover; background-repeat: no-repeat; background-position: center center;">
            </div>
            ...
            <div class="card_text"
                ...
                <div class="card_text_head "
                    ...
                    <div class="card_text_left" id="hAddress"
                        style="{{ $id_card->student_address == 0 ? 'display:none' : '' }}">
                        <h3
...
<div id="vertical" class="overflow-auto {{ $id_card->page_layout_style == 'vertical' ? 'd-block' : 'd-none' }}"
    ...
    <div class="vertical__card"
        ...
        <div class="horizontal_card_header"
            ...
            <div class="logo__img logoImage vLogo"
                style="line-height:1.02; width: 80px; background-image: url({{ $id_card->logo != '' ? asset($id_card->logo) : asset(generalSetting()->logo) }});background-size: cover; height: 30px;background-position: center center; background-repeat: no-repeat;">
            </div>
                ...
                <div class="card_text_head "
                    ...
                    <div class="card_text_left vId">
                        ...
                        <div id="vAdmissionNumber" style="{{ $id_card->admission_no == 0 ? 'display:none' : '' }}">
                            <h4 style="line-height:1.02; margin-top: 0; margin-bottom: 3px; font-size:10px;">Admission
                                No : 001</h4>
                        </div>
                        @if (moduleStatusCheck('University'))
                            <div id="hSession" style="{{ $id_card->un_session == 0 ? 'display:none' : '' }}">
