                                                    ...
                                                    <td>
                                                        ...
                                                        <x-drop-down>
                                                            <a class="dropdown-item" data-toggle="modal"
                                                                data-target="#previewIdCard{{ $id_card->id }}"
                                                                href="#">
                                                                @lang('admin.preview')
                                                            </a>
                                                            ...
                                                            <div class="modal-body p-3">
                                                                ...
                                                                @if (!in_array(3, $roleId))
                                                                        ...
                                                                        <div id="horizontal"
                                                                            ...
                                                                            <div class="horizontal__card"
                                                                                ...
                                                                                <div class="horizontal_card_header"
                                                                                    ...
                                                                                    <div class="qr__img"
                                                                                        style="line-height:1.02; width: 30px;">
                                                                            ...
                                                                            background-image: url({{ @$id_card->profile_image != '' ? asset(@$id_card->profile_image) : asset('public/uploads/staff/demo/staff.jpg') }}); background-size: cover; background-position: center center; background-repeat: no-repeat; line-height:1.02; width: {{ !empty($id_card->user_photo_width) ? $id_card->user_photo_width : 21.166666667 }}mm; flex: 80px 0 0; height: {{ !empty($id_card->user_photo_height) ? $id_card->user_photo_height : 21.166666667 }}mm; margin: auto; padding: 3px; align-content: center; justify-content: center; display: flex; border: 3px solid #fff;">
                                                                                ...
                                                                                <div class="horizontal_card_footer"
                                                                                    style="line-height:1.02; text-align: right;">
                                                                    ...
                                                                    @if ($id_card->page_layout_style == 'vertical')
                                                                        <div id="vertical" class="overflow-auto"
                                                                            ...
                                                                            <div class="vertical__card"
                                                                                ...
                                                                                <div class="horizontal_card_header"
                                                                                    ...
                                                                                    <div class="qr__img"
                                                                                        style="line-height:1.02; width: 48px; position: absolute; right: 4px; top: 4px;">
                                                                                ...
                                                                                <div class="vertical_card_body"
                                                                                    ...
                                                                                    <div class="thumb vSize vSizeX photo vImg vRoundImg"
                                                                                        style="background-image: url({{ @$id_card->profile_image != '' ? asset(@$id_card->profile_image) : asset('public/uploads/staff/demo/staff.jpg') }});
                                                                            @if (@$id_card->user_photo_style == 'round') {{ 'border-radius : 50%;' }} @endif
                                                                             ...
                                                                             background-image: url({{ @$id_card->profile_image != '' ? asset(@$id_card->profile_image) : asset('public/uploads/staff/demo/staff.jpg') }});background-size: cover; background-position: center center; background-repeat: no-repeat; line-height:1.02; flex: 80px 0 0; width: {{ !empty($id_card->user_photo_width) ? $id_card->user_photo_width : 21.166666667 }}mm; flex: 80px 0 0; height: {{ !empty($id_card->user_photo_height) ? $id_card->user_photo_height : 21.166666667 }}mm; margin: auto;border-radius: 50%; padding: 3px; align-content: center; justify-content: center; display: flex; border: 3px solid #fff;">
                                                                                    ...
                                                                                    <div class="card_text"
                                                                                        ...
                                                                                        justify-content: space-between;">
                                                                                                <div class="single__child"
                                                                                                    style="text-align: center; flex: 45px 0 0; ">
                                                                    ...
                                                                    @if ($id_card->page_layout_style == 'vertical')
                                                                        ...
                                                                        background-image: url({{ @$id_card->profile_image != '' ? asset(@$id_card->profile_image) : asset('public/uploads/staff/demo/staff.jpg') }}); line-height:1.02; width: {{ !empty($id_card->user_photo_width) ? $id_card->user_photo_width : 13.229166667 }}mm; height: {{ !empty($id_card->user_photo_height) ? $id_card->user_photo_height : 13.229166667 }}mm; flex-basis: {{ !empty($id_card->user_photo_width) ? $id_card->user_photo_width : 13.229166667 }}mm; flex-grow: 0; flex-shrink: 0; margin-right: 20px; background-size: cover; background-position: center center;">
                                                                                ...
                                                                                justify-content: start;">
                                                                                        <div class="single__child"
                                                                                            style="text-align: center; flex: 75px 0 0; ">
                                                                                            <div class="single__child__thumb"
                                                                                                style=" background-image: url('{{ asset('public/uploads/staff/demo/staff.jpg') }}');background-size: cover; background-position: center center; background-repeat: no-repeat; line-height:1.02; width: 45px;
                                                                                    flex: 45px 0 0;
                                                                                    height: 46px; margin: auto;border-radius: 50%; padding: 3px; align-content: center; justify-content: center; display: flex; border: 3px solid #fff;">
                                                                                            ...
                                                                                            <p
                                                                                                style="font-size:12px; font-weight:400; margin-bottom: 0;">
                                                                                                Child 01</p>
                                                                                        </div>
                                                                                        <div class="single__child"
                                                                                            style="text-align: center;flex: 75px 0 0;">
                                                                                    ...
                                                                                    <div class="card_text_head "
                                                                                        ...
                                                                                        @if ($id_card->student_address == 1)
                                                                                            <div
                                                                                                class="card_text_left gVAddress">
                                                                                                <h3
                                                                                                    style="line-height:1.02; margin-top: 0; margin-bottom: 5px; font-size:10px; font-weight:500; text-transform:uppercase;">
                                                                                                    {{ generalSetting()->address }}
                                                                                                </h3>
