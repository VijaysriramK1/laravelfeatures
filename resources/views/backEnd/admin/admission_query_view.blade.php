                        ...
                        <div class="col-lg-4">
                            <div class="primary_input">
                                ...
                                <input class="primary_input_field read-only-input form-control" type="text"
                                    name="name" id="name" value="{{ @$admission_query->name }}" required>
                        ...
                        <div class="col-lg-4">
                            <div class="primary_input">
                                ...
                                <input oninput="phoneCheck(this)"
                                    ...
                                    name="phone" id="phone" value="{{ @$admission_query->phone }}">
                        ...
                        <div class="col-lg-4">
                            <div class="primary_input">
                                ...
                                <input oninput="emailCheck(this)"
                                    class="primary_input_field read-only-input form-control" type="text"
                                    name="email" value="{{ @$admission_query->email }}">
                        ...
                        <div class="col-lg-4">
                            <div class="primary_input">
                                <label class="primary_input_label" for="">@lang('academics.assigned')
                                    <span></span></label>
                                <input class="primary_input_field read-only-input form-control" type="text"
                                    name="assigned" value="{{ @$admission_query->assigned }}" id="assigned"
                                    required>
                        ...
                        <div class="col-lg-3">
                            <div class="primary_input">
                                ...
                                <input oninput="numberCheck(this)"
                                    ...
                                    name="no_of_child" value="{{ @$admission_query->no_of_child }}" id="no_of_child"
                                    required>
