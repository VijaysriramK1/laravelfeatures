                                            ...
                                            <div class="col">
                                                <div class="primary_input">
                                                    ...
                                                    <input
                                                        ...
                                                        id="startDate" type="text" name="follow_up_date" readonly="true"
                                                        value="{{ @$admission_query->follow_up_date != '' ? date('m/d/Y', strtotime(@$admission_query->follow_up_date)) : date('m/d/Y') }}">
                                        ...
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="primary_input">
                                                    ...
                                                    <input
                                                        class="primary_input_field  primary_input_field date form-control form-control{{ @$errors->has('follow_up_date') ? ' is-invalid' : '' }}"
                                                        id="startDate" type="text" name="next_follow_up_date"
                                                        readonly="true"
