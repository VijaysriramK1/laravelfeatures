...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            ...
            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'admission-query-search', 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id' => 'sma_form']) }}
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="">@lang('admin.date_from')
                                        {{-- <span
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="">@lang('admin.date_to')
                                        {{-- <span
                                            class="text-danger"> *</span> --}}
                                    </label>
                                    <div class="primary_datepicker_input">
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input">
                                    ...
                                    <select name="source"
                                        ...
                                        <option data-display="@lang('admin.select_source') *" value="">@lang('admin.select_source') *
                                        </option>
                            ...
                            <div class="col-lg-3">
                                <div class="primary_input">
                                    <label class="primary_input_label" for="">@lang('common.status')
                                        {{-- <span
                                            class="text-danger"> *</span> --}}
                                    </label>
                                    <select
                                        ...
                                        name="status">
                                        <option data-display="@lang('admin.select_status') *" value="">@lang('admin.Status') *
                                        </option>
                                        @foreach ($status as $statuses)
                                            <option value="{{ @$statuses->name }}"
                                                {{ isset($status_id) ? ($status_id == $statuses->id ? 'selected' : '') : '' }}>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                                ...
                                                <textarea class="primary_input_field form-control" cols="0" rows="3" name="address" id="address"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="primary_input">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="">@lang('admin.assigned')
                                                    *<span></span></label>
                                                <input class="primary_input_field read-only-input form-control"
                                                    type="text" name="assigned" id="assigned">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <select class="primary_select " name="reference" id="reference">
                                                <option data-display="@lang('admin.reference') *" value="">
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            if (data == 1) {
                                return '<span class="badge badge-danger" style="padding:5px 8px;font-size:12px;">Pending</span>';
                            } else if (data == 2) {
                                return '<span class="badge badge-success" style="padding:5px 8px;font-size:12px;">Converted</span>';
                            } else {
                                return 'N/A';
                            }
                        }
