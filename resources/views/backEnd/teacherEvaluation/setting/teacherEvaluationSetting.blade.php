        ...
        <div class="container-fluid p-0">
            <div class="row mt-40">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'teacher-evaluation-setting-update', 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'sma_form']) }}
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6 primary_input sm_mb_20">
                                                            <input type="radio" name="is_enable"
                                                                id="teacherEvaluationEnable" class="common-radio"
                                                                value="0"
                                                        ...
                                                        <div class="col-lg-6 primary_input sm_mb_20">
                                                            <input type="radio" name="is_enable"
                                                                id="teacherEvaluationDisable" class="common-radio"
                                                                value="1"
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6 primary_input sm_mb_20 p-1">
                                                            <input type="checkbox" name="submitted_by[]" id="submitted_by1"
                                                        ...
                                                        <div class="col-lg-6 primary_input sm_mb_20 p-1">
                                                            <input type="checkbox" name="submitted_by[]" id="submitted_by2"
