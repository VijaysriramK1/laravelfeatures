                                                                ...
                                                                <div class="primary_input">
                                                                    ...
                                                                    <div class="primary_datepicker_input">
                                                                        <div class="no-gutters input-right-icon">
                                                                            ...
                                                                            <button class="btn-date" disabled
                                                        ...
                                                        <div class="row">
                                                                            ...
                                                                            <div class="col">
                                                                                <div class="">
                                                                                    <input disabled
                                                                                        ...
                                                                                        type="text"
                                                                                        name="date_of_birth"
                                                                                        value="{{ isset($student->date_of_birth) ? date('m/d/Y', strtotime($student->date_of_birth)) : date('m/d/Y') }}"
                                                                                        autocomplete="off">
                                                                                </div>
                                                                            </div>
                                                                            <button class="btn-date" disabled
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input">
                                                                    ...
                                                                    <input class="primary_input_field" disabled
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 mt-4   ">
                                                                <div class="primary_input">
                                                                    ...
                                                                    <input oninput="emailCheck(this)" disabled
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input">
                                                                    ...
                                                                    <input oninput="phoneCheck(this)" disabled
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                ...
                                                                <div class="primary_input">
                                                                    ...
                                                                    <textarea disabled class="primary_input_field form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}"
                                            ...
                                            <div class="row pt-4 row-gap-24">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input">
                                                                    ...
                                                                    <input disabled oninput="phoneCheck(this)"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input">
                                                                    ...
                                                                    <input disabled class="primary_input_field"
                                                ...
                                                <div class="col-lg-6 guardian_section">
                                                    <div class="form-section">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h4 class="modal-title">@lang('common.select_sibling')
                                                                        </h4>
                                                        ...
                                                        <div class="row mb-20 student-details"
                                                            id="siblingInfo">
                                                            @foreach ($siblings as $sibling)
                                                            @if ($sibling->id != $student->id)
                                                            <div
                                                                class="col-sm-12 col-md-6 col-lg-3 mb-30">
                                                        ...
                                                        <div class="parent_details" id="parent_details">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                @php
                                                                if (
                                                                $student->parents->guardians_relation ==
                                                                'F'
                                                                ) {
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 mt-4">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea disabled class="primary_input_field form-control" cols="0" rows="4" name="guardians_address"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-lg-12 mt-4">
                                                                                <div class="primary_input">
                                                                                    ...
                                                                                    <textarea disabled class="primary_input_field form-control" cols="0" rows="4" name="additional_notes">{{ $student->aditional_notes }}</textarea>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-12">
                                                                        <div class="primary_input">
                                                                            ...
                                                                            <textarea disabled class="primary_input_field form-control" cols="0" rows="4"
                    ...
                    <div class="white-box">
                        ...
                        <div class="row">
                            <div class="col-lg-12 student-add-form">
                                <ul class="nav nav-tabs tabs_scroll_nav px-0" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#basic_info_edit" role="tab"
                                            data-toggle="tab">@lang('student.personal_info')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#parents_and_guardian_info_edit" role="tab"
                                            data-toggle="tab">@lang('student.parents_and_guardian_info')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#document_info_edit" role="tab"
                                            data-toggle="tab">@lang('student.document_info')</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#previous_school_info_edit" role="tab"
                                            data-toggle="tab">@lang('student.previous_school_info')</a>
                                    </li>
                                    <!-- <li class="nav-item">
                                        <a class="nav-link" href="#Other_info_edit" role="tab"
                                            data-toggle="tab">@lang('student.Other_info')</a>
                                    </li> -->
                                    <li class="nav-item">
                                        <a class="nav-link" href="#custom_field_edit" role="tab"
                                            data-toggle="tab">@lang('student.custom_field')</a>
                                    </li>
                                ...
                                <div class="student-add-form-container">
                                    <div class="tab-content">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade"
                                            id="parents_and_guardian_info_edit">
                                            <div class="row pt-4 row-gap-24">
                                                <div class="col-lg-12">
                                                    <div class="form-section">
                                                        @if (generalSetting()->with_guardian)
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="document_info_edit">
                                            <div class="row pt-4 row-gap-24">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="previous_school_info_edit">
                                            <div class="row pt-4 row-gap-24">
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                        ...
                                        <div role="tabpanel" class="tab-pane fade" id="custom_field_edit">
                                            <div class="form-section">
                                                @if (is_show('custom_field'))
                                                @if (count($custom_fields) && is_show('custom_field') && isMenuAllowToShow('custom_field'))
                                                <div class="row">
...
<script>
    ...
    $(document).ready(function() {
        var getLocalData = localStorage.getItem('studentpagestatus');
        if (getLocalData == 'edit') {
            var displayPart = document.querySelector('.editpart');
            displayPart.style.display = 'block';
        } else if (getLocalData == 'view') {
            var displayPart = document.querySelector('.viewpart');
            displayPart.style.display = 'block';
        } else {
            var displayPart = document.querySelector('.editpart');
            displayPart.style.display = 'block';
...
<script>
    $(document).ready(function() {
        ...
        $("#admission_date-icon").on("click", function() {
            $("#admissiondate").focus();
        });
