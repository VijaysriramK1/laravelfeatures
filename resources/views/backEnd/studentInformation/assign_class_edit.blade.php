...
<div class="row">
        ...
        <div class="col-lg-12 mt-25">
            <div class="primary_input">
                <div class="primary_input">
                    ...
                    <select class="primary_select  form-control{{ $errors->has('badge_id') ? ' is-invalid' : '' }}"
                        name="badge_id">
                        <option data-display="@lang('admin.badge') @if (is_required('badge_id') == true) * @endif"
                            value="">
                            @lang('admin.badge')
                            @if (is_required('badge_id') == true)
                                <span class="text-danger"> *</span>
    ...
    <div class="col-lg-12 mt-25">
        ...
        <div class="d-flex radio-btn-flex mt-10">
            ...
            <div class="mr-30">
                <input type="radio" name="is_default" id="isDefaultYesEdit" value="1"
                    class="common-radio relationButton" {{ $record->is_default == 1 ? 'checked' : '' }}>
                <label for="isDefaultYesEdit">@lang('common.yes')</label>
            </div>
            <div class="mr-30">
                <input type="radio" name="is_default" id="isDefaultNoEdit" value="0"
                    class="common-radio relationButton" {{ $record->is_default == 0 ? 'checked' : '' }}>
                <label for="isDefaultNoEdit">@lang('common.no')s</label>
            </div>
    ...
    <div class="col-lg-12 text-center mt-25">
        <div class="mt-40 d-flex justify-content-between">
            <button type="button" class="primary-btn tr-bg" data-bs-dismiss="modal">@lang('admin.cancel')</button>
