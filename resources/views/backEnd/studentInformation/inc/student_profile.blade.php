<div class="white-box">
    ...
    <div class="student-meta-box">
        ...
        <div class="white-box radius-t-y-0">
            ...
            @endif
            @if (generalSetting()->badge_system == 1 && $student_detail->defaultClass != '')
            <div class="single-meta">
                <div class="d-flex justify-content-between">
                    <div class="name">
                        @lang('admin.badge')
                    ...
                    <div class="value">
                        ...
                        <img class="img-thumbnail" style="width: 50px;height:50px;"
                            src="{{ asset(@$student_detail->defaultClass->badge?->image ?? 'public/uploads/badges/default-badge.png') }}"
                            alt="">
                    </div>
                </div>
            </div>
            ...
            @if (Auth::check() && Auth::user()->student && Auth::user()->student->active_status == 2)
            <div class="single-meta">
                <div class="d-flex justify-content-between">
                    <div class="name">
                        Status
            ...
            @else
            <!-- No student or active_status not equal to 2 -->
            @endif
