@php
    ...
    $is_result_available = App\SmResultStore::where([['class_id', $record->class], ['section_id', $record->section], ['student_id', $record->student]])
                            ...
                            <div class="single-report-admit">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="d-flex">
                                            <div class="col-lg-2">
                                                <img class="logo-img" src="{{ asset(generalSetting()->logo) }}"
                                                ...
                                                <table class="table mb-0">
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            @foreach ($result_setting as $assinged_exam)
                                                                <th class="text-center">
                                                                    ...
                                                                    ({{ @$assinged_exam->exam_percentage }}%)</th>
                                                            @endforeach
                                                        ...
                                                        @foreach ($subjects as $assignsubject)
                                                            <tr>
                                                                <td class="text-center">
                                                                    {{ @$assignsubject->subject->subject_name }}</td>
                                                                <td class="text-center">100</td>
                                                                <td class="text-center">
                                                                    {{ @$assignsubject->subject->pass_mark }}</td>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <th class="text-center">
                                                                {{ avgSubjectPassMark($all_subject_ids) }}</th>
