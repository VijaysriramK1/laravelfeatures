                        ...
                        <div class="row">
                            ...
                            @if (moduleStatusCheck('University'))
                                @includeIf(
                                    ...
                                    ['hide' => ['USUB'], 'required' => ['USN', 'UD', 'UA', 'US', 'USL']]
                                )
                                <div class="col-lg-3 mt-25">
                                    <select
                                        class="primary_select form-control{{ $errors->has('month') ? ' is-invalid' : '' }}"
                                        name="month">
                                ...
                                <div class="col-lg-3 mt-25">
                                    <select
                                        class="primary_select form-control{{ $errors->has('year') ? ' is-invalid' : '' }}"
                                        name="year">
                            ...
                            <div class="main-title">
                                <h3 class="mb-15">@lang('student.student_attendance_report')
                                    <small> <span class="text-success">P:<span id="total_present"></span></span>
                                        ...
                                        <span class="text-info">F:<span id="total_halfday"></span></span> </small>
                                </h3>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div>
                                <div class="table-responsive">
                                    <table id="table_id1" style="margin-bottom:25px"
                                        class="display school-table table-responsive" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
