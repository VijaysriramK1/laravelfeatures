        ...
        <div class="container-fluid">
            <div class="row justify-content-between">
                ...
                <div class="bc-pages">
                    ...
                    <a href="{{ route('student_list') }}">@lang('student.student_list')s</a>
                ...
                <div class="col-lg-9 student-details up_admin_visitor">
                    <div class="white-box">
                        <ul class="nav nav-tabs tabs_scroll_nav mb-10" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ $type == 'studentTimeline' ? 'active' : '' }} "
                                    href="#studentTimeline" role="tab" data-toggle="tab">@lang('student.timeline')</a>
                            </li>
                            <li class="nav-item">
                            ...
                            @if (moduleStatusCheck('University'))
                                <li class="nav-item">
                                    <a class="nav-link {{ $type == 'assign_subject' ? 'active' : '' }} "
                                        href="#studentSubject" role="tab" data-toggle="tab">@lang('university::un.subject')</a>
                                </li>
                            @endif
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel"
                                ...
                                <div>
                                    <div class="text-right mb-20">
                                        @if (userPermission(1201))
                                            <button class="primary-btn-small-input primary-btn small fix-gr-bg"
                                                type="button" data-toggle="modal" data-target="#assignClass"> <span
                                    ...
                                    <table id="" class="table simple-table table-responsive school-table"
                                        ...
                                        <thead class="d-block">
                                            <tr class="d-flex">
                                                @if ($setting->badge_system == 1)
                                                    <th class="col-2">@lang('admin.badge')</th>
                                                @endif
                                                @if (moduleStatusCheck('University'))
                                                ...
                                                @endif
                                                <th class="col-{{ $setting->multiple_roll == 1 ? 2 : 4 }}"
                                                    style="text-align: center">@lang('student.action')</th>
                                            </tr>
                                        </thead>
                                        <tbody class="d-block">
                                            @foreach ($records->where('active_status', 1) as $record)
                                                <tr class="d-flex">
                                                    @if ($setting->badge_system == 1)
                                                        <td class="col-2">
                                                            <img width="32" height="32" style="border-radius:50%"
                                                                src="{{ asset($record->badge?->image ?? 'public/uploads/badges/default-badge.png') }}"
                                                                alt="">
                                                        </td>
                                                    @endif
                                                    @if (moduleStatusCheck('University'))
                                                    ...
                                                    @endif
                                                    <td class="col-{{ $setting->multiple_roll == 1 ? 2 : 4 }}"
                                ...
                                <div>
                                    ...
                                    @foreach ($timelines as $timeline)
                                        <div class="student-activities">
                                            ...
                                            <div class="modal fade admin-query"
                                                id="deleteTimelineModal{{ $timeline->id }}">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">@lang('common.delete')</h4>
                            ...
                            @if (moduleStatusCheck('University'))
                                <div role="tabpanel"
                                    class="tab-pane fade {{ $type == 'assign_subject' ? ' active show' : '' }}"
                                    id="studentSubject">
