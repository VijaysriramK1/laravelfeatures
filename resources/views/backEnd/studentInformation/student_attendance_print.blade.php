            ...
            <tr>
                ...
                <td style="text-aligh:center">
                    @if (moduleStatusCheck('University'))
                        ...
                        <p style="font-size:14px !important; border-bottom:1px solid gray" align="left"
                            class="text-white">@lang('university::un.semester(label)'):
                            {{ isset($unSemesterLabel) ? $unSemesterLabel->semesterDetails->name . '(' . (isset($unSemesterLabel) ? $unSemesterLabel->name : '') . ')' : '' }}
                        </p>
                    @else
                        <p style="font-size:14px !important; border-bottom:1px solid gray" align="left"
                            class="text-white">{{ __('academics.class') }}: {{ $class->class_name }} </p>
                        <p style="font-size:14px !important; border-bottom:1px solid gray" align="left"
                            class="text-white">{{ __('academics.section') }}: {{ $section->section_name }} </p>
                    @endif
                    <p style="font-size:14px !important; border-bottom:1px solid gray" align="left"
                        class="text-white">{{ __('hr.month') }}: {{ date('F', strtotime('00-' . $month . '-01')) }} </p>
                    <p style="font-size:14px !important; border-bottom:1px solid gray" align="left"
                        class="text-white">{{ __('common.year') }}: {{ $year }} </p>
