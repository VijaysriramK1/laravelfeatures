        ...
        <div class="col-lg-12 p-0">
            <div class="header_iner d-flex justify-content-between align-items-center">
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    ...
                    <select name="#" class="nice_Select bgLess mb-0 sma_session" id="sma_session">
                    ...
                    {{-- @if (@$styles && Auth::user()->role_id == 1)
                        @if (generalSetting()->style_btn == 1)
                            <select class="nice_Select bgLess mb-0 sma_theme_style" id="sma_theme_style">
                    ...
                    @if (generalSetting()->lang_btn == 1)
                        <select class="nice_Select bgLess mb-0 languageChange" id="languageChange">
                            ...
                            @foreach ($languages as $lang)
                                <option data-display="{{ $lang->language_universal }}"
                                    value="{{ $lang->language_universal }}"
                    ...
                    <ul class="header_notification_warp d-flex align-items-center">
                        ...
                        @if (app('general_settings')->get('chatting_method') == null || app('general_settings')->get('chatting_method') == 'log')
                            <jquery-notification-component :unreads="{{ json_encode($notifications_for_chat) }}"
                        ...
                        @else
                            <notification-component :unreads="{{ json_encode($notifications_for_chat) }}"
                                :user_id="{{ json_encode(auth()->id()) }}"
                                :redirect_url="{{ json_encode(route('chat.index')) }}"
                                :asset_type="{{ json_encode(asset('/public')) }}"
                                :mark_all_as_read_url="{{ json_encode(route('chat.notification.allRead')) }}">
                        ...
                        <li class="scroll_notification_list">
                            <a class="pulse theme_color bell_notification_clicker show_notifications" href="#">
                                <!-- bell   -->
                                <img src="{{ asset('public/backEnd/assets/img/icons/notification.svg') }}"
                                    alt="">
                                ...
                                <div class="Notification_body">
                                    ...
                                    @forelse ($notifications as $notification)
                                        <div class="single_notify d-flex align-items-center"
                                            ...
                                            <a href="{{ $notification->url }}" class="unread_notification flex-grow-1"
                                            ...
                                            <h5 class="notification_time text-nowrap">
                                                {{ formatedDate($notification->created_at) }}</h5>
                    ...
                    <div class="redirect_links">
                        <div class="select_style d-flex">
                            @if (generalSetting()->website_btn == 1)
                                <a target="_blank" class=" mr-10 tab_hide" href="{{ url('/') }}"><img
                                        src="{{ asset('public/backEnd/assets/img/icons/globe.svg') }}"
                                        alt=""></a>
                            @endif
                            ...
                            @if (generalSetting()->report_btn == 1)
                                @if (Auth::user()->role_id == $coltroller_role)
                                    <a class="mr-10 tab_hide" href="{{ route('student_report') }}"><img
                                            src="{{ asset('public/backEnd/assets/img/icons/report.svg') }}"
                                            alt=""></a>
                                @endif
                            @endif
                            ...
                            <div class="profile_info_details">
                                ...
                                @if (Auth::user()->role_id == '2' && Auth::user()->is_saas == 0)
                                    <a href="{{ route('student-profile') }}">
                                        <img src="{{ asset('public/backEnd/assets/img/icons/profile.svg') }}"
                                            class="mr-1" alt="">
                                ...
                                @if (config('app.app_sync') && auth()->user()->role_id != 1)
                                    @if (auth()->user()->staff && auth()->user()->staff->parent_id && auth()->user()->role_id == 3)
                                        <a href="{{ route('viewAsRole') }}">
                                            ...
                                            <img src="{{ asset('public/backEnd/assets/img/icons/key.svg') }}"
                                                alt="" class="mr-1">
                                ...
                                <a href="{{ route('updatePassowrd') }}">
                                    <img src="{{ asset('public/backEnd/assets/img/icons/password.svg') }}"
                                        alt="">
                                ...
                                <a href="{{ Auth::user()->role_id == 2 ? route('student-logout') : route('logout') }}"
                                    ...
                                    <img src="{{ asset('public/backEnd/assets/img/icons/logout.svg') }}"
                                        alt="">
                                    @lang('common.logout')
