                                        ...
                                        <tbody>
                                            @foreach ($my_leaves as $my_leave)
                                                @php
                                                    ...
                                                    $extra_days =
                                                        $remaining_days < 0 ? $approved_leaves - $my_leave->days : 0;
                                                @endphp
                                                <tr>
                                                    <td>{{ $my_leave->leaveType != '' ? $my_leave->leaveType->type : '' }}
                                                    </td>
                                                    <td>{{ $remaining_days >= 0 ? $remaining_days : 0 }}</td>

                                                    <td>{{ $remaining_days < 0 ? $approved_leaves - $my_leave->days : 0 }}
                                                    </td>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="row">
                        <div class="col-lg-12">
                            @if (isset($apply_leave))
                                {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => ['student-leave-update', $apply_leave->id], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) }}
                            @else
                                        ...
                                        <div class="col-lg-12">
                                            <select
                                                ...
                                                @foreach ($leave_types as $leave_define)
                                                    <option value="{{ $leave_define->id }}"
                                                        {{ isset($apply_leave) ? ($apply_leave->leave_define_id == $leave_define->id ? 'selected' : '') : '' }}>
                                                        {{ $leave_define->leaveType->type }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col">
                                            <div class="primary_input">
                                                ...
                                                <input
                                                    ...
                                                    id="startDate" type="text" name="leave_from" autocomplete="off"
                                        ...
                                        <div class="col-lg-12 text-center">
                                            ...
                                            @if (isset($apply_leave))
                                                <button class="primary-btn fix-gr-bg submit" data-toggle="tooltip"
                                                    title="{{ $tooltip }}">
                                                    <span class="ti-check"></span> @lang('leave.update_apply_leave')</button>
                                            @else
                                                <button class="primary-btn fix-gr-bg submit" data-toggle="tooltip"
                                                    title="{{ $tooltip }}">
                                                    <span class="ti-check"></span> @lang('leave.save_apply_leave')</button>
                                            @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        @if ($apply_leave->approve_status == 'C')
                                                            <button
                                                                class="primary-btn small bg-danger text-white border-0">@lang('leave.cancelled')</button>
                                                        @endif
                                                    </td>
                                                    <td>
                                                        <div class="dropdown CRM_dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                ...
                                                                @if ($apply_leave->approve_status == 'P')
                                                                    @if (userPermission('student-leave-edit'))
                                                                        <a class="dropdown-item"
                                                                            href="{{ route('student-leave-edit', [$apply_leave->id]) }}">@lang('common.edit')</a>
                                                                    @endif
                                                                ...
                                                                @if ($apply_leave->file != '')
                                                                    <a class="dropdown-item"
                                                                        href="{{ url(@$apply_leave->file) }}" download>
                                                                        @lang('leave.download')
