                                ...
                                <select
                                    ...
                                    @if (isset($studentDetails))
                                        <option data-display="{{ $studentDetails->section->section_name }}"
                                            value="{{ $studentDetails->section->id }}" selected>
                                ...
                                <select
                                    ...
                                    @if (isset($studentDetails))
                                        <option data-display="{{ $studentDetails->student->full_name }}"
                                            value="{{ $studentDetails->student->id }}" selected>
                                                    ...
                                                    <div class="student_marks_table">
                                                        <div class="row">
                                                            <div class="col-lg-7 text-black">
                                                                <h3
                                                                    style="border-bottm:1px solid #ddd; padding: 15px; text-align:center">
                                                                    @lang('exam.student_final_mark_sheet')
                                                                </h3>
                                                                <h3>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <p class="mb-0">
                                                                            @lang('exam.pass_mark') : &nbsp; &nbsp; &nbsp; &nbsp;
                                                                            &nbsp; &nbsp; <span
                                                                                class="primary-color fw-500">{{ @$studentDetails->class->pass_mark }}</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <table class="table mb-0">
                                                                        ...
                                                                        @if (count($result_setting))
                                                                            @foreach ($result_setting as $assinged_exam)
                                                                                <th class="text-center">
                                                                                    {{ @$assinged_exam->examTypeName->title }}
                                                                                    ({{ @$assinged_exam->exam_percentage }}%)
                                                                                </th>
                                                                            @endforeach
                                                                        @else
                                                                            @foreach (examTypes() as $assinged_exam)
                                                                                <th class="text-center">
                                                                                    {{ @$assinged_exam->title }} </th>
                                                                            @endforeach
                                                                        @endif
                                                                    ...
                                                                    @foreach ($subjects as $assignsubject)
                                                                        <tr>
                                                                            <td class="text-center">
                                                                                {{ @$assignsubject->subject->subject_name }}
                                                                            </td>
                                                                            @if (count($result_setting))
                                                                                <td class="text-center">
                                                                                    {{ subject100PercentMark() }}</td>
                                                                            @else
                                                                                <td class="text-center">
                                                                                    {{ @allExamsSubjectTotalMark($assignsubject->subject->id) }}
                                                                                </td>
                                                                            @endif
                                                                            <td class="text-center">
                                                                                {{ @$assignsubject->subject->pass_mark }}
                                                                            </td>
                                                                            @if (count($result_setting))
                                                                                @foreach ($result_setting as $examRule)
                                                                                    <td class="text-center">
                                                                                        {{ singleSubjectMark($record_id, $assignsubject->subject->id, $examRule->exam_type_id)[0] }}
                                                                                    </td>
                                                                                @endforeach
                                                                            @else
                                                                                @foreach (examTypes() as $examRule)
                                                                                    <td class="text-center">
                                                                                        {{ singleSubjectMark($record_id, $assignsubject->subject->id, $examRule->id, true)[0] }}
                                                                                    </td>
                                                                                @endforeach
                                                                            @endif
                                                                            <td class="text-center">
                                                                                {{ @subjectAverageMark($record_id, $assignsubject->subject->id)[0] }}
                                                                            </td>
                                                                            <td class="text-center"></td>
                                                                            <td class="text-center">
                                                                                {{ getGrade(subjectAverageMark($record_id, $assignsubject->subject->id)[0], true) }}
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
                                                                <tfoot>
                                                                    <tr>
                                                                        ...
                                                                        <th class="text-center">
                                                                            {{ @$studentDetails->class->pass_mark }}</th>
                                                                        @if (count($result_setting))
                                                                            @foreach ($result_setting as $exam)
                                                                                <th class="text-center">
                                                                                    {{ allExamSubjectMark($record_id, $exam->id)[0] }}
                                                                                </th>
                                                                            @endforeach
                                                                        @else
                                                                            @foreach (examTypes() as $exam)
                                                                                <th class="text-center">
                                                                                    {{ allExamSubjectMark($record_id, $exam->id, null)[0] }}
                                                                                </th>
                                                                            @endforeach
                                                                        @endif
                                                                        <th class="text-center">
                                                                            {{ allExamSubjectMarkAverage($record_id, $all_subject_ids) }}
                                                                        </th>
                                                                        <th class="text-center">
                                                                        ...
                                                                        <th class="text-center">
                                                                            {{ getGrade(allExamSubjectMarkAverage($record_id, $all_subject_ids), true) }}
                                                                        </th>
