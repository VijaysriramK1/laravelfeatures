                                    ...
                                    <div class="logo_thumb_upper">
                                        ...
                                        <h2>
                                            ...
                                            @if (isset($subjectInfo->subject_name))
                                                <p class="text-white">@lang('exam.subject') :
                                                    {{ $subjectInfo->subject_name }}</p>
                                            @endif
                                            @if (moduleStatusCheck('University'))
                                                <p class="text-white">@lang('university::un.semester') : {{ $data['semester'] }} -
                                                    {{ $data['semester_label'] }} ({{ $data['session'] }}) </p>
                                            @else
                                                <p class="text-white">@lang('common.class') : {{ @$classInfo->class_name }}
                                                    ({{ @$sectionInfo->section_name }})</p>
                                            @endif
                                        </h2>
                                    </div>
