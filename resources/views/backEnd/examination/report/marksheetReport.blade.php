                        ...
                        @else
                            ...
                            <div class="col-lg-3 mt-30-md md_mb_20" id="examTypeBaseSubjectDiv">
                                <select
                                    ...
                                    id="examTypeBaseSubjectList" name="subject">
                                ...
                                <div class="card-header">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <h3 class="text-white">@lang('exam.subject') : {{ $subjectInfo->subject_name }}
                                            </h3>
                                            <h3 class="text-white">@lang('common.class') : {{ $classInfo->class_name }}
                                                ({{ $sectionInfo->section_name }})</h3>
                                        </div>
                                                    ...
                                                    <table class="mt-30 mb-20 table table-bordered w-100 scrolled_table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            @foreach ($mark_sheet as $data)
                                                                ...
                                                                <tr>
                                                                    <td>{{ $data->studentRecords->student->full_name }}
                                                                    </td>
                                                                    <td>{{ $data->studentRecords->student->admission_no }}
                                                                    </td>
                                                                    ...
                                                                    @else
                                                                        <td>{{ @subjectFullMark($data->exam_type_id, $data->subject->id) }}
                                                                        </td>
                                                                    @endif
                                                                    <td>{{ $pass_mark }}</td>
