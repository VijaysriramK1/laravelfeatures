                                ...
                                @else
                                    <div class="col-lg-6 col-md-6 ">
                                        <select
                                            ...
                                            <option data-display="@lang('student.select_class') *" value="">@lang('student.select_class') *
                                            </option>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <p class="mb-0">
                                                                            @lang('common.academic_year') : &nbsp;<span
                                                                                class="primary-color fw-500">{{ @generalSetting()->academic_year->year }}
                                                                                [{{ @generalSetting()->academic_year->title }}]</span>
                                                                        </p>

                                                                        <p class="mb-0">
                                                                            @lang('student.class') : <span
                                                                                class="primary-color fw-500">{{ @$class->class_name }}</span>
                                                                        </p>

                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <p class="mb-0">
                                                                            @lang('exam.examination') : <span
                                                            ...
                                                            <table class="table mb-0 mt-20">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($finalMarkSheets as $finalMarkSheet)
                                                                        <tr>
                                                                            <td class="pl-3">
                                                                                {{ @$finalMarkSheet->get('student_name') }}
                                                                            </td>
                                                                            <td>{{ @$finalMarkSheet->get('admission_no') }}
                                                                            </td>
                                                                            ...
                                                                            <td> {{ number_format($finalMarkSheet->get('avg_mark'), 2) }}
                                                                            </td>
                                                                            <td>
                                                                                @if ($finalMarkSheet->get('avg_mark') >= avgSubjectPassMark($all_subject_ids))
                                                                                    @lang('exam.pass')
                                                                                @else
                                                                                    @lang('exam.fail')
                                                                                @endif
                                                                            </td>
                                                                            <td>{{ getGrade($finalMarkSheet->get('avg_mark'), true) }}
                                                                            </td>
                                                                        </tr>
                                                                    @endforeach
                                                                </tbody>
