                            ...
                            <td style="padding: 0">
                                <div class="logo_img">
                                    ...
                                    <div class="profile_thumb">
                                        <img src="{{ file_exists(@$student_detail->student_photo) ? asset($student_detail->student_photo) : asset('public/uploads/staff/demo/staff.jpg') }}"
                                            alt="{{ @$student_detail->full_name }}" height="100" width="100">
                                    </div>
                                </div>
                            </td>
                        </thead>
                        ...
                        <tr>
                            ...
                            @if (count($result_setting))
                                @foreach ($result_setting as $assinged_exam)
                                    <th class="text-center">{{ @$assinged_exam->examTypeName->title }}
                            ...
                            <tr>
                                ...
                                @else
                                    <td class="text-center">
                                        {{ @allExamsSubjectTotalMark($assignsubject->subject->id) }}</td>
                                @endif
                                ...
                                <td></td>
                                <td>{{ getGrade(subjectAverageMark($record_id, $assignsubject->subject->id)[0], true) }}
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
                        ...
                        <tr>
                            ...
                            @else
                                @foreach (examTypes() as $exam)
                                    <th class="text-center">{{ allExamSubjectMark($record_id, $exam->id, null)[0] }}
                                    </th>
                                @endforeach
                            @endif
