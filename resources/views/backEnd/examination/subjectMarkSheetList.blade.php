                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 text-black">
                                                                ...
                                                                <div class="row mt-20">
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <p class="mb-0">
                                                                            @lang('exam.subject') : <span
                                                                                class="primary-color fw-500">{{ @$subject->subject_name }}
                                                                                [{{ @$subject->subject_code }}]</span>
                                                                        </p>
                                                                        <p class="mb-0">
                                                                            @lang('exam.pass_mark') : <span
                                                                                class="primary-color fw-500">{{ @$subject->pass_mark }}</span>
                                                                        </p>
                                                            ...
                                                            <table class="table mb-0 mt-20">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @foreach ($finalMarkSheets as $finalMarkSheet)
                                                                        <tr>
                                                                            <td>{{ @$finalMarkSheet->get('student_name') }}
                                                                            </td>
                                                                            ...
                                                                            @foreach ($finalMarkSheet->get('examTypeMarks') as $examMark)
                                                                                @php
                                                                                    ...
                                                                                    $exam_count += 1;
                                                                                @endphp
                                                                                <td>{{ $examMark->get('single_avg_mark') }}
                                                                                </td>
                                                                            @endforeach
