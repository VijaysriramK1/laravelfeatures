                                            ...
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div>
                                                    ...
                                                    @if (userPermission('delete-notice-view'))
                                                        <a class="deleteUrl" data-modal-size="modal-md"
                                                            title="Delete Notice"
                                                            href="{{ route('delete-notice-view', $value->id) }}"><button
                                                                class="primary-btn small tr-bg">@lang('common.delete')
                                                            </button></a>
                                                    @endif
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        @if (isset($roleData))
                                                            @foreach ($roleData as $role)
                                                                @php
                                                                    $name = \Modules\RolePermission\Entities\SmaRole::select('name')->where('id', $role)->first();
                                                                @endphp
                                                                <p class="mb-0">
