                ...
                <div id="attendance-btn-part">
                    <div class="d-flex justify-content-end">
                        <a id="attendance-btn-id" type="button"
                            class="primary-btn fix-gr-bg nowrap attendance-btn-cls disabled-cls">@lang('student.attendance')</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function attendanceList() {
            ...
            $('#attendance-table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: '/admin-attendance-search?class_id=' + class_id +
        ...
        $(document).on('click', '.attendance-btn-cls', function(e) {
            ...
            var reloadUrl = '/admin-attendance-search?class_id=' + classId + '&section_id=' +
