                ...
                <div class="col-sm-8 col-lg-5 col-xl-4 col-md-7">
                    ...
                    <div class="in_login_content">
                        ...
                        <div class="in_login_page_iner">
                            ...
                            <form method="POST" class="loginForm" action="{{ route('customer_register') }}"
                                id="sma_form">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="primary_input mb-40 in_single_input">
                                            <select
                                                class="mb-26 niceSelect sma_theme_style w-100 bb form-control{{ $errors->has('school_id') ? ' is-invalid' : '' }}"
                                                name="school_id" id="select-school">
                                                <option data-display="Select School *" value="">Select school *
                                                </option>
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="@lang('auth.enter_name')" name="fullname"
                                ...
                                <div class="in_single_input">
                                    <input type="text" placeholder="@lang('auth.enter_email')" name="email"
                                ...
                                <div class="in_single_input">
                                    <input type="password" placeholder="@lang('auth.enter_password')" name="password"
