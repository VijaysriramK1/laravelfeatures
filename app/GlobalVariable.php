...
class GlobalVariable
{
    ...
    public static function GlobarModuleLinks()
    {
        try {
            ...
            $permissions = SmaPermissionAssign::where('role_id', Auth::user()->role_id)->where('school_id', Auth::user()->school_id)->get();
    ...
    public static function SaasRoleModule()
    {
        try {
            ...
            $permissions = SmaPermissionAssign::where('role_id', Auth::user()->role_id)->get();
