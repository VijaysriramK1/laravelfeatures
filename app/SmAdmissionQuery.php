...
class SmAdmissionQuery extends Model
{
    ...
    {
        return $this->hasMany(SmAdmissionQueryFollowup::class, 'admission_query_id');
    }

    public function attachments()
    {
        return $this->hasMany(SmAdmissionQueryAttachment::class, 'admission_query_id');
    }

    public function reminders()
    {
        return $this->hasMany(SmAdmissionQueryReminder::class, 'admission_query_id');
    }
}
