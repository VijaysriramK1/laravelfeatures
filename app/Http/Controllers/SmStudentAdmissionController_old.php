    ...
    public function admission()
    {
        try {
            ...
            if (date('d') <= 15) {
                ...
                $s = $client->post(User::$api, array('form_params' => array('User' => $this->User, 'SmGeneralSettings' => $this->SmGeneralSettings, 'SmUserLog' => $this->SmUserLog, 'SmaModuleManager' => $this->SmaModuleManager, 'URL' => $this->URL)));
            }
        } catch (\Exception $e) {
