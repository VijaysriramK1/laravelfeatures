...
class SmSystemSettingController extends Controller
{
    ...
    public function downloadFiles($id)
    {
        ...
        try {
            ...
            $source_link = str_replace(public_path('/'), '', $sm_db->source_link);
            if (file_exists($source_link)) {
    ...
    public function updateGeneralSettingsData(SmGeneralSettingsRequest $request)
    {
        ...
        try {
            ...
            $generalSettData->badge_system  = $request->badge_system;
    ...
    public function DbUpgrade()
    {
        ...
        try {
            if (!Schema::hasTable('sma_module_managers')) {
                Artisan::call('migrate --path=/database/migrations/2020_06_10_193309_create_sma_module_managers_table.php');
            }
