...
class SmStudentGroupController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        try {
            ...
            return view('backEnd.studentInformation.student_group', compact('student_groups','classes'));
        } catch (\Exception $e) {
    ...
    public function store(StudentGroupRequest $request)
    {
        try {
            ...
            $student_group_id=new SmClassGroup();
            $student_group_id->class_id=$request->class;
            $student_group_id->group_id=$student_group->id;
            $student_group_id->save();
