...
use Modules\SmaBiometrics\Entities\SmaBioSetting;
...
class SmApiController extends Controller
{
    ...
    public function AttendanceSync(Request $request)
    {
        ...
        try {
            ...
            $attendance_setting = SmaBioSetting::find(1);
    ...
    public function member_role(Request $request)
    {
        ...
        $roles = SmaRole::where('active_status', '=', 1)->where(function ($q) {
    ...
    public function saveUploadContent(Request $request)
    {
        ...
        try {
            ...
            foreach ($request->available_for as $value) {
                if ($value == 'admin') {
                    $roles = SmaRole::where('id', '=', 1) /* ->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9) */->where('academic_id', SmAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where(function ($q) {
                        $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
                    })->get();
    ...
    public function staffList(Request $request)
    {
        ...
        try {
            ...
            $roles = SmaRole::where('active_status', '=', '1')->where('id', '!=', 2)->where('id', '!=', 3)->where(function ($q) {
    ...
    public function staffRoles(Request $request)
    {
        ...
        try {
            $roles = SmaRole::where('active_status', '=', '1')
                ->where(function ($q) {
                    $q->where('school_id', 1)->orWhere('type', 'System');
                })
                ->select('id', 'name', 'type')
    ...
    public function searchStaff(Request $request)
    {
        ...
        try {
            ...
            $staffs = $staff->get();
            $roles = SmaRole::where('active_status', '=', '1')->where('id', '!=', 2)->where('id', '!=', 3)->get();
    ...
    public function staffAttendance(Request $request)
    {
        ...
        try {
            $roles = SmaRole::where('active_status', '=', '1')->where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 10)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function saas_staffAttendance(Request $request, $school_id)
    {
        ...
        try {
            $roles = SmaRole::where('active_status', '=', '1')->where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 10)
                ->where('school_id', $school_id)->get();
    ...
    public function staffAttendanceReportSearch(Request $request)
    {
        ...
        try {
            ...
            $roles = SmaRole::where('id', '!=', 3)->where('id', '!=', 2)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    //         $roles = SmaRole::where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where(function ($q) {
    //             $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
    //         })->get();
    //         if (ApiBaseMethod::checkUrl($request->fullUrl())) {
    //             $data = [];
    ...
    public function saas_sendMessage(Request $request, $school_id)
    {
        ...
        try {
            $roles = SmaRole::where('school_id', $school_id)->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($roles, null);
            }
            return view('backEnd.communicate.sendMessage', compact('roles'));
    ...
    {
        try {
            $roles = SmaRole::select('*')->where('id', '!=', 1)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    {
        try {
            $roles = SmaRole::where('active_status', '=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9)->orderBy('id', 'desc')->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                return ApiBaseMethod::sendResponse($roles, null);
    ...
    public function role_edit(Request $request, $id)
    {
        try {
            ...
            $roles = SmaRole::where('active_status', '=', 1)->orderBy('id', 'desc')->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function role_delete(Request $request)
    {
        ...
        try {
            $delete_query = SmaRole::destroy($request->id);
            if (ApiBaseMethod::checkUrl($request->fullUrl())) {
                if ($delete_query) {
    ...
    public function saas_studentExamScheduleApi(Request $request, $school_id, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $exam_schedule = DB::table('sm_exam_schedules')
                ...
                ->where('sm_exam_schedules.section_id', '=', @$student_detail->section_id)
                ->where('sm_exam_schedules.academic_id', SmAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('sm_exam_schedules.school_id', $school_id)->get();
    ...
    public function saas_studentTimelineApi(Request $request, $school_id, $id)
    {
        ...
        if (ApiBaseMethod::checkUrl($request->fullUrl())) {
            ...
            $timelines = DB::table('sm_student_timelines')
                ...
                ->where('sm_student_timelines.academic_id', SmAcademicYear::SINGLE_SCHOOL_API_ACADEMIC_YEAR())->where('sm_student_timelines.school_id', $school_id)->get();
    ...
    public function uploadContent(Request $request)
    {
        ...
        if ($request->input('available_for') == 'admin') {
            $roles = SmaRole::where('id', '!=', 1)->where('id', '!=', 2)->where('id', '!=', 3)->where('id', '!=', 9)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
    ...
    public function pendingLeave(Request $request)
    {
        ...
        try {
            ...
            $leave_types = SmLeaveType::where('active_status', 1)->get();
            $roles = SmaRole::where('id', '!=', 1)->where('id', '!=', 3)->get();
    ...
    public function saas_pendingLeave(Request $request, $school_id)
    {
        ...
        try {
            ...
            $leave_types = SmLeaveType::where('active_status', 1)->get();
            $roles = SmaRole::where('id', '!=', 1)->where('id', '!=', 3)->where(function ($q) {
                $q->where('school_id', Auth::user()->school_id)->orWhere('type', 'System');
            })->get();
