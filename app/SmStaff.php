...
class SmStaff extends Model
{
    ...
    {
        return $this->belongsTo('Modules\RolePermission\Entities\SmaRole', 'role_id', 'id')->withDefault();
    }
    ...
    {
        return $this->belongsTo('Modules\RolePermission\Entities\SmaRole', 'previous_role_id', 'id')->withDefault();
    }
    ...
    {
        return $this->hasMany(SmStudentAttendanceRequest::class, 'staff_id', 'id');
    }
}
