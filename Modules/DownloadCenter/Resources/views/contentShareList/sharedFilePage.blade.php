...
<head>
    ...
    @endif
    <title>{{ @schoolConfig()->school_name ? @schoolConfig()->school_name : 'SMA Edu ERP' }} |
    ...
    <div class="shared-link-container">
        <div class="shared-link-content-container">
            <div class="company_logo">
                <img src="{{ asset(schoolConfig()->logo ? schoolConfig()->logo : 'public/uploads/settings/logo.png') }}"
                    ...
                    @foreach ($contents as $content)
                        <li class="attached-content-item">
                            @if (@$content->youtube_link)
                                <a href="{{ $content->youtube_link }}" target="_blank">{{ $content->file_name }}</a>
                            @else
                                <a href="{{ url("$content->upload_file") }}" download>{{ $content->file_name }}
