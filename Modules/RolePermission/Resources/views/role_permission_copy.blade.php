        ...
        <div class="mesonary_role_header">
            ...
            @foreach ($all_modules as $key => $row)
                @php
                    ...
                    $module_info = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->where('active_status', 1)->where('parent_id', 0)->first();

                    $all_group_modules = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->where('active_status', 1)->where('id', '!=', $key)->get();
                    ...
                    <div class="single_permission" id="{{ $module_info->id }}">
                        ...
                        <div class="permission_header d-flex align-items-center justify-content-between">
                            ...
                            <div>
                                ...
                                <label
                                    for="Main_Module_{{ $key }}">{{ __('rolepermission::permissions.' . $module_info->name) }}</label>
                            </div>
