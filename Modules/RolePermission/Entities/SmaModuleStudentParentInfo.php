...
class SmaModuleStudentParentInfo extends Model
{
    ...
    public function subModule()
    {
        ...
        return $this->hasMany('Modules\RolePermission\Entities\SmaModuleStudentParentInfo', 'parent_route', 'route')->whereNotNull('route')->where('route', '!=', '')
