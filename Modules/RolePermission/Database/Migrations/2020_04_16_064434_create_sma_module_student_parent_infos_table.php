...
class CreateSmaModuleStudentParentInfosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sma_module_student_parent_infos', function (Blueprint $table) {
            $table->increments('id');
        ...
        // DB::table('sma_module_student_parent_infos')->truncate();
        ...
        foreach ($datas as $data) {
            $new = new SmaModuleStudentParentInfo();
            $new->id = $data[0];
    ...
    {
        Schema::dropIfExists('sma_module_student_parent_infos');
    }
}
