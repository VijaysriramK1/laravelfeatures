        ...
        <div class="container-fluid p-0">
            <div class="row mt-40">
                <div class="col-lg-6">
                    <div class="row">
                        <div class="col-lg-12">
                            {{ Form::open(['class' => 'form-horizontal', 'files' => true, 'route' => 'behaviour_records.setting_update', 'method' => 'PUT', 'enctype' => 'multipart/form-data', 'id' => 'sma_form']) }}
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6 primary_input sm_mb_20 p-1">
                                                            ...
                                                            <label for="studentComment"
                                                                class="mt-0">@lang('behaviourRecords.student_comment')</label>
                                                        </div>
                                                        <div class="col-lg-6 primary_input sm_mb_20 p-1">
                                                            <input type="checkbox" name="parentComment" id="parentComment"
                                                                class="common-checkbox permission-checkAll" value="1"
                                                                {{ $setting->parent_comment == 1 ? 'checked' : '' }}>
                                                            <label for="parentComment"
                                                                class="mt-0">@lang('behaviourRecords.parent_comment')</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="row">
                                                        <div class="col-lg-6 primary_input sm_mb_20 p-1">
                                                            ...
                                                            <label for="studentView"
                                                                class="mt-0">@lang('behaviourRecords.student_view')</label>
                                                        </div>
                                                        <div class="col-lg-6 primary_input sm_mb_20 p-1">
                                                            <input type="checkbox" name="parentView" id="parentView"
                                                                class="common-checkbox permission-checkAll" value="1"
                                                                {{ $setting->parent_view == 1 ? 'checked' : '' }}>
                                                            <label for="parentView"
                                                                class="mt-0">@lang('behaviourRecords.parent_view')</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
