                                ...
                                <div class="add-visitor">
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="primary_input">
                                                <input
                                                    ...
                                                    value="{{ isset($sidebar) ? $sidebar->name : old('name') }}">
                                                <input type="hidden" name="id"
                                                    value="{{ isset($sidebar) ? $sidebar->id : '' }}">
                                    ...
                                    <div class="row  mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ @$errors->has('icon_class') ? ' is-invalid' : '' }}"
                                                    type="text" name="icon_class" autocomplete="off"
                                                    value="{{ isset($sidebar) ? $sidebar->icon_class : old('icon_class') }}">
                                    ...
                                    <div class="row mt-25">
                                        <div class="col-lg-12">
                                            <div class="primary_input">
                                                <input
                                                    class="primary_input_field form-control{{ @$errors->has('route') ? ' is-invalid' : '' }}"
                                                    type="text" name="route" autocomplete="off"
                                                    value="{{ isset($sidebar) ? $sidebar->route : old('route') }}">
                            ...
                            <div class="erp_role_permission_area ">
                                                ...
                                                <div class="single_permission" id="{{ $module_info->id }}">
                                                    ...
                                                    <div
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="{{ route('menumanage.edit', [$module_info->id]) }}">
                                                                <i class="fa fa-edit"></i> </a>
                                                            <label
                                                                for="Main_Module_{{ $key }}">{{ $module_info->name }}</label>
                                                        </div>

                                                        <div class="arrow collapsed" data-toggle="collapse"
                                                            data-target="#Role{{ $module_info->id }}">
                                                    ...
                                                    <div id="Role{{ $module_info->id }}" class="collapse">
                                                        <div class="permission_body">
                                                            <ul>
                                                                ...
                                                                $subModule = DB::table('sidebars')
                                                                    ->where('parent_id', $module_info->sma_module_id)
                                                                ...
                                                                @foreach ($subModule as $row2)
                                                                    ...
                                                                    @else
                                                                        <li>
                                                                            <div class="submodule">
                                                                                <a
                                                                                    href="{{ route('menumanage.edit', [$row2->id]) }}">
                                                                                    <i class="fa fa-edit"></i> </a>

                                                                                <label
                                                                                    for="Sub_Module_{{ $row2->id }}">{{ $row2->name }}</label>
                                                                                <br>
                                                                            </div>
                                ...
                                @else
                                    {{ Form::open([
                                        ...
                                        'files' => true,
                                        'route' => 'menumanage.store.sidebar',
                                        'method' => 'POST',
                                    ]) }}
                                        ...
                                        @foreach ($all_modules as $key => $row)
                                            @php
                                                ...
                                                if (moduleStatusCheck('SaasRolePermission') == true) {
                                                    $module_info = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->first();
                                                    $all_group_modules = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->where('id', '!=', $key)->get();
                                                } else {
                                                    $module_info = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->where('is_saas', 0)->first();
                                                    $all_group_modules = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->where('id', '!=', $key)->where('is_saas', 0)->get();
                                                }

                                                $all_group_modules = Modules\RolePermission\Entities\SmaModuleInfo::where('module_id', $key)->where('id', '!=', $key)->where('active_status', 1)->get();
                                                    ...
                                                    <div id="Role{{ $module_info->id }}" class="collapse">
                                                        <div class="permission_body">
                                                            <ul>
                                                                ...
                                                                $subModule = DB::table('sma_module_infos')
                                                                    ->where('parent_id', $module_info->id)
                                                                    ->where('active_status', 1)
                                                                    ->get();
                                                                ?>
                                                                @foreach ($subModule as $row2)
