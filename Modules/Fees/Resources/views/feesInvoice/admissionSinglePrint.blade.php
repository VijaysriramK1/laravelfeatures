                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="addressleft_text">
                                                            ...
                                                            <p><span>@lang('student.class')</span> <span>: {{$invoiceInfo->studentInfo->class ? $invoiceInfo->studentInfo->class->class_name : 'N/A' }}</span> </p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
            ...
            <table class="table border_table mb_30 description_table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>
                            {{@$invoiceInfo->studentInfo->payment_method}}
