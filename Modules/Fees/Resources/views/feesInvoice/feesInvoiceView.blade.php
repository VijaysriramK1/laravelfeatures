            ...
            <table class="table border_table mb_30 description_table" >
                ...
                @foreach ($invoiceDetails as $key=>$invoiceDetail)
                    @php
                        ...
                        $total_scholarship_amount += $invoiceDetail->scholarship_amount; // Sum up scholarship amounts

                        $totalAmount = ($invoiceDetail->amount + $invoiceDetail->fine) - $invoiceDetail->weaver;
                        $grand_total += $totalAmount ;

                        $total = ($invoiceDetail->amount + $invoiceDetail->fine) - ($invoiceDetail->paid_amount + $invoiceDetail->weaver + $invoiceDetail->scholarship_amount);
                        $balance += $total;
                    @endphp
                    <tr>
                        <td>{{$key+1}}</td>
                        ...
                        <td>{{($invoiceDetail->paid_amount)? $invoiceDetail->scholarship_amount : 0}}</td>
                ...
                <tr>
                    <td colspan="5"></td>
                    <td colspan="2">
                        <p class="total_count"><span>Total Scholarship Amount</span> <span>{{currency_format($total_scholarship_amount)}}</span></p>
                    </td>
                </tr>
                <tr>
                    <td colspan="5"></td>
