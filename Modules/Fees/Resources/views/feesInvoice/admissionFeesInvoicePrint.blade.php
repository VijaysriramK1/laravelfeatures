        ...
        <div class="invoice_wrapper">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="addressleft_text">
                                                            ...
                                                            <p><span><strong>@lang('student.student_name') </span> <span class="nowrap">: {{$invoiceInfo->studentInfo->title}}</span> </strong></p>
                                                            <p><span>@lang('student.class_section')</span> <span>: {{$invoiceInfo->studentInfo->class ? $invoiceInfo->studentInfo->class->class_name : 'N/A' }}</span> </p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <div class="addressright_text">
                                                            ...
                                                            <p><span>@lang('fees.create_date') </span> <span>: {{dateConvert($invoiceInfo->created_at)}}</span> </p>
                                                            <!-- <p><span>@lang('fees.due_date') </span> <span>: {{dateConvert($invoiceInfo->due_date)}}</span> </p>                                                            <p> -->
                                                            <span>
            ...
            <table class="table border_table mb_30 description_table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$key+1}}</td>
                        <td>{{$invoiceInfo->studentInfo->title}}</td>
                        <td>{{$invoiceInfo->studentInfo->class ? $invoiceInfo->studentInfo->class->class_name : 'N/A' }}</td>
                        <td>{{$invoiceInfo->studentInfo->payment_method}}</td>
            ...
            @if(@$invoiceInfo->studentInfo =='Bank')
            <div class="col-lg-12">
                <table class="table border_table mb_30 description_table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach(admissionInvoiceInfo as $key=>$bank)
                        <tr>
                            <td>{{$key+1}}</td>
