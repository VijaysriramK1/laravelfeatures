                            ...
                            <div class="add-visitor">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-15">
                                        <div id="common_select_class_div">
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12" id="selectStudentDiv">
                                        <div id="common_select_section_div">
                                            ...
                                            <select class="primary_select form-control{{ $errors->has('section_id') ? ' is-invalid' : '' }}" id="common_select_section" name="section_id">
                                                ...
                                                <option value="{{ $section->id }}" {{ isset($section_id) ? ($section_id == $section->section_id ? 'selected' : '') : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-15">
                                        <div id="common_select_group_div">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="common_select_group">{{ __('Group') }}
                                                    <!-- <span class="text-danger">*</span> -->
                                                </label>
                                                <select class="primary_select form-control{{ $errors->has('group') ? ' is-invalid' : '' }}" id="common_select_group">
                                                    <option data-display="@lang('common.select_group')" value="">{{ __('common.select_group') }}</option>

                                                    @foreach ($smgroups as $smgroup)
                                                    <option value="{{ $smgroup->id }}" {{ isset($group_id) && $group_id == $smgroup->id ? 'selected' : '' }}>
                                                        {{ $smgroup->group }}
                                                    </option>
                                                    @endforeach

                                                </select>
                                                <div class="pull-right loader loader_style" id="common_select_group_loader" style="display:none;">
                                                    <img class="loader_img_style" src="{{ asset('public/backEnd/img/demo_wait.gif') }}" alt="loader">
                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mt-15">
                                        <div id="common_select_category_div">
                                            <div class="primary_input">
                                                <label class="primary_input_label" for="common_select_category">@lang('student.student_category')
                                                    <!-- <span class="text-danger">*</span> -->
                                                </label>
                                                <select class="primary_select form-control{{ $errors->has('group') ? ' is-invalid' : '' }}" id="common_select_category">
                                                    <option data-display="@lang('student.student_category')" value="">{{ __('student.student_category') }}</option>

                                                    @foreach ($studentCategorys as $studentCategory)
                                                    <option value="{{ $studentCategory->id }}">{{ $studentCategory->category_name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="pull-right loader loader_style" id="common_select_category_loader" style="display:none;">
                                                    <img class="loader_img_style" src="{{ asset('public/backEnd/img/demo_wait.gif') }}" alt="loader">
                                                </div>
                                ...
                                <div class="row mt-15">
                                    <div class="col-lg-12" id="selectStudentDiv">
                                        <div id="common_select_student_div">
                                            ...
                                            <select class="primary_select form-control{{ $errors->has('student') ? ' is-invalid' : '' }}"
                                                ...
                                                <option data-display="@lang('reports.select_student')" value="">
                                                    @lang('reports.select_student') <span></span>
                                                </option>
                                                @isset($students)
                    ...
                    <div class="row mt-15">
                        <div class="col-lg-12">
                            <div class="pb-0 fees_invoice_type_div">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <input type="hidden" name="student_id" value="{{ old('student_id', $student_id ?? '') }}">
                                ...
                                <table class="table school-table-style fees_invoice_type_table" cellspacing="0" width="100%">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td class="coverageAmount">0.00</td>
    ...
    $(document).ready(function() {
        ...
        $("#common_select_class").on("change", function() {
            ...
            $.ajax({
                ...
                beforeSend: function() {
                    $('#common_select_section_loader').show();
                },
                success: function(data) {
                ...
                complete: function() {
                    ...
                    $('#common_select_section_loader').hide();
                }
            });
        });
        ...
        $('#common_select_section').on('change', function() {
            ...
            if (sectionId) {
                $('#common_select_group_loader').show();

                $.ajax({
                    url: "{{ route('section-to-group') }}",
                    method: 'GET',
                    data: {
                        id: sectionId
                    },
                    ...
                    success: function(response) {
                        let groupSelect = $('#common_select_group');
                        groupSelect.empty();
                        ...
                        if (response && response.groups && response.groups.length) {
                            $.each(response.groups, function(index, group) {
                                groupSelect.append('<option value="' + group.id + '">' + group.group + '</option>');
                            });
                        } else {
                            console.log('No groups found or invalid response format.');
                        }

                        $('#common_select_group_loader').hide();
                        $('#common_select_group').niceSelect('update');
                    },
        ...
        //group to category
        $('#common_select_group').on('change', function() {
            let groupId = $(this).val();

            if (groupId) {
                $('#common_select_category_loader').show();

                $.ajax({
                    url: "{{ route('group-to-category') }}",
                    method: 'GET',
                    data: {
                        id: groupId
                    },
                    dataType: 'json',
                    success: function(response) {
                        let categorySelect = $('#common_select_category');
                        ...
                        if (response && response.categories && response.categories.length) {
                            ...
                            console.log('No categories found or invalid response format.');
                        }

                        $('#common_select_category_loader').hide();
                        $('#common_select_category').niceSelect('update');
                    },
                    error: function(xhr, status, error) {
                        $('#common_select_category_loader').hide();
        ...
        $('#common_select_group').on('change', function() {
            ...
            if (groupId) {
                ...
                $('#common_select_student_loader').show();
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    success: function(response) {
                        let studentSelect = $('#common_select_student');
                        studentSelect.empty();
                        studentSelect.append("<option value=''>@lang('reports.select_student')</option>");

                        console.log(response);

                        if (response && response.students && response.students.length) {
                        ...
                        $('#common_select_student_loader').hide();
        ...
        $('#common_select_category').on('change', function() {
            let categorygroupId = $(this).val();

            if (categorygroupId) {
                $('#common_select_student_loader').show();

                $.ajax({
                    url: "{{ route('fetch-category-students') }}",
                    method: 'GET',
                    data: {
                        student_category_id: categorygroupId
                    },
                    dataType: 'json',
                    success: function(response) {
                        let studentSelect = $('#common_select_student');
                ...
                $('#common_select_student').empty();
                $('#common_select_student').append('<option value="">@lang("reports.select_student")</option>');
                $('#common_select_student_loader').hide();
            }
        });
        ...
        $("#common_select_section").on("change", function() {
            ...
            if (subject == true) {
                getSubject(class_id, section_id, student_group_id);
            }
        });
    });

    $('#common_select_student').change(function() {
        console.log('Dropdown changed');
        var studentId = $(this).val();
        $('input[name="student_id"]').val(studentId);
        console.log("Hidden Student ID: " + $('input[name="student_id"]').val());
    });
</script>
