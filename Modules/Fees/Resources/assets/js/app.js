...
function subTotalAmount(el, amount) {
    ...
    var coverageAmount = parseFloat($(el).closest('tr').find('.coverageAmount').text()) || 0;
    
   
    var result =   amount - coverageAmount;
    
    
    $(el).closest('tr').find('.subTotal').html(result.toFixed(2));
    $(el).closest('tr').find('.inputSubTotal').val(result.toFixed(2));
}
