    ...
    @foreach ($payrollDetails as $payrollDetail)
        <div class="invoice_wrapper">
                ...
                <div class="container">
                    <div class="invoice_part_iner">
                        ...
                        <div class="table_title">
                            <h3> @lang('hr.payslip_for_the_period_of') {{ $payrollDetail->payroll_month }}
                                {{ $payrollDetail->payroll_year }}</h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="invoice_wrapper_body">
                <h4 class="invoice f_w_400">@lang('hr.payslip') #@if (isset($payrollDetail))
                        {{ $payrollDetail->id }}
                    @endif
                </h4>
                    ...
                    <table class="table mb_30">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if (isset($payrollDetail))
                                        {{ $payrollDetail->staffDetails->full_name }}
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    @if (isset($payrollDetail))
                                        {{ $payrollDetail->staffDetails->departments->name }}
                                    @endif
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    @if (isset($payrollDetail))
                                        {{ @$payrollDetail->staffDetails->designations->title }}
                                    @endif
                                </td>
                            </tr>
                        </tbody>
                    ...
                    <table class="table mb_30">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td> {{ @$setting_info->currency_symbol }} @if (isset($payrollDetail))
                                        {{ $payrollDetail->basic_salary }}
                                    @endif
                                </td>
                            </tr>
                            <tr>
