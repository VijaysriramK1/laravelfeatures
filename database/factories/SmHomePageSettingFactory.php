...
class SmHomePageSettingFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'long_title' => 'SG ERP',
            'short_description' => 'Managing various administrative tasks in one place is now quite easy and time savior with this SG ERP and Give your valued time to your institute that will increase next generation productivity for our society.',
