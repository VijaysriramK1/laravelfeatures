...
class CreateSmHomePageSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        $s->long_title = 'SG ERP';
        $s->short_description = 'Managing various administrative tasks in one place is now quite easy and time savior with this SG ERP and Give your valued time to your institute that will increase next generation productivity for our society.';
        $s->link_label = 'Learn More About Us';
        $s->link_url = 'http://example.com/about';
