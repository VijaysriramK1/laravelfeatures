...
return new class extends Migration
{
    public function up()
    {
        ...
        //DownloadCenter 
        $exist = SmaModuleManager::where('name', 'DownloadCenter')->first();
        if (!$exist) {
        ...
        //AiContent 
        $exist2 = SmaModuleManager::where('name', 'AiContent')->first();
        if (!$exist2) {
            ...
            $s2->is_default = 0;
            $s2->addon_url = "maito:support@example.com";
        ...
        //WhatsappSupport 
        $exist3 = SmaModuleManager::where('name', 'WhatsappSupport')->first();
        if (!$exist3) {
            $s3 = new SmaModuleManager();
            $s3->name = "WhatsappSupport";
            $s3->email = 'support@example.com';
            $s3->notes = "This is WhatsApp Support module. Send message via WhatsApp.";
            $s3->version = "1.0";
            $s3->update_url = "https://example.com/contact";
            $s3->is_default = 0;
            $s3->addon_url = "maito:support@example.com";
