...
class CreateSmGeneralSettingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('sm_general_settings')->insert([
            [
                'copyright_text' => 'Copyright &copy; 2024 All rights reserved | This application is made by SG Academy',
                ...
                'currency' => 'USD',
                'currency_symbol' => '$',
                'school_name' => 'School Edu',
                'site_title' => 'School Education software',
                'session_id' => 1,
                'week_start_id' => 3,
                'time_zone_id' => 51,
