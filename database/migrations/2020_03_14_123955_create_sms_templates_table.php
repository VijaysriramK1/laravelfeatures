    ...
    public function up()
    {
        ...
        $allTempletes = [
                                                    ...
                                                    <div class="txtTinyMce-wrapper" style="line-height:1.2;font-size:12px;font-family:Arial, Helvetica Neue, Helvetica, sans-serif;color:#262b30;">
                                                        <p style="margin:0;font-size:12px;line-height:1.2;text-align:center;margin-top:0;margin-bottom:0;">
                                                            ...
                                                            <span style="background-color:transparent;text-align:left;">
                                                                <font color="#ffffff">
                                                                    Copyright &copy; 2020 All rights reserved | This application is made by SG Academy
                                                                </font>
                                                            </span>
                                                            <br>
                                                        </p>
            ...
            [
                ...
                '',
                '[student_name], [school_name], [username], [password]'
            ],
            ...
            [
                ...
                '',
                '[contact_name], [contact_email], [contact_subject], [contact_message], [school_name]'
            ],

            [
                'email',
                'communication_sent_email',
                'Sent Email',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                ...
                '',
                '[title], [description], [school_name]'
            ],

            [
                'email',
                'parent_login_credentials',
            ...
            [
                ...
                '',
                '[name], [school_name], [username], [password]'
            ],
            ...
            [
                ...
                '',
                '[student_name], [due_amount], [fees_name], [date], [school_name]'
            ],
            ...
            [
                ...
                '',
                '[parent_name], [student_name], [note], [date], [school_name]'
            ],

            [
                'email',
                'student_reject_bank_payment',
                'Reject Bank Payment',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                ...
                '',
                '[student_name], [note], [date], [school_name]'
            ],
            ...
            [
                ...
                'Wallet',
                '[name], [add_balance], [method], [create_date], [school_name], [current_balance]'
            ],
            ...
            [
                ...
                'Wallet',
                '[name], [add_balance], [method], [create_date], [school_name], [reject_reason], [current_balance]'
            ],

            [
                'email',
                'fees_extra_amount_add',
                'Fee Extra Amoun Add',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                ...
                'Wallet',
                '[name], [school_name], [add_balance], [method], [create_date], [previous_balance], [current_balance]'
            ],
            ...
            [
                ...
                'Wallet',
                '[name], [refund_amount], [school_name], [create_date], [current_balance]'
            ],
            ...
            [
                'email',
                'student_registration_for_parents',
                'Student Registration',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                ...
                'ParentRegistration',
                '[father_name], [school_name], [username], [password]'
            ],
            ...
            [
                ...
                'Lead',
                '[assign_user], [lead_name], [lead_phone], [lead_email], [lead_date], [lead_time], [lead_description], [school_name]'
            ],

            [
                'email',
                'student_course_purchase',
                'Lms Course Purchase',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
            ...
            [
                'email',
                'student_approve_payment',
                'Approve Lms Course Payment',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                        <td style="vertical-align:top;" valign="top">
            ...
            [
                'email',
                'student_reject_payment',
                'Reject Lms Course Payment',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                        <td style="vertical-align:top;" valign="top">
            ...
            [
                'email',
                'university_fees_remainder',
                'University Fees Due Remainder',
                '<table bgcolor="#FFFFFF" cellpadding="0" cellspacing="0" class="nl-container" style="table-layout:fixed;vertical-align:top;min-width:320px;border-spacing:0;border-collapse:collapse;background-color:#FFFFFF;width:100%;" width="100%">
                <tbody>
                    <tr style="vertical-align:top;" valign="top">
                        <td style="vertical-align:top;" valign="top">
                ...
                'University',
                '[fees_type], [fees_type], [amount], [semester_label], [academic], [due_date], [class],[section]'
            ],
            ...
            <tbody>
                ...
                '',
                '[name], [email], [role], [apply_date], [leave_from], [leave_to], [reason]'
            ],
            ...
            [
                ...
                '',
                '[name], [email], [role], [apply_date], [leave_from], [leave_to], [reason], [status]'
            ],
