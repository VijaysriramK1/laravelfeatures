...
class CreateSmStylesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('sm_styles', function (Blueprint $table) {
            ...
            $table->string('path_sma_style', 255)->nullable();
        ...
        // $s->path_sma_style = 'blue_version/sga.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_sma_style = 'orange_version/sga.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_sma_style = 'paste_version/sga.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_sma_style = 'darkblue_version/sga.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_sma_style = 'pink_version/sga.css';
        // $s->primary_color = '#415094';
        ...
        // $s->path_sma_style = 'dark_version/sga.css';
        // $s->primary_color = '#000';
