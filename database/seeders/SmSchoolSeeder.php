...
class SmSchoolSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>2,
        //                             'email'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@example.com', 
        //                             'username'=>'student_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@example.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        //                         User::factory()->times(1)->create([
        //                             'role_id' =>3,
        //                             'email'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@example.com', 
        //                             'username'=>'guardian_'.$data->class_id.'_'.$data->section_id.'_'.$i.'@example.com',
        //                             'school_id' =>$school->id,
        //                         ]);
        ...
        //                 }
        //             }
        //             $rules = SmaRole::where('active_status', '=', '1')->where('id', '!=', 1) /* ->where('id', '!=', 2) */->where('id', '!=', 3)->where('id', '!=', 10)->get();
        ...
        //         for ($j = 1; $j <= 541; $j++) {
        //             $permission = new SmaPermissionAssign();
        ...
        //         foreach ($ids as $id) {
        //             $permission = SmaPermissionAssign::where('school_id', $school->id)->where('role_id', 5)->where('module_id', $id)->first();
        //             if ($permission) {
        //                 $permission->delete();
        //             }
        //         }
        ...
        //                 $theme->path_sma_style = 'lawngreen_version/sga.css';
        //                 $theme->path_sma_style = false;                   
        //                 $theme->box_shadow = true;                   
        //             }else {
        //                 $theme->path_main_style = 'style.css';
        //                 $theme->path_sma_style = 'sga.css';
