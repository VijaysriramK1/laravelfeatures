(function ($) {
    ...
    // select item name from selecting item category name
    $(document).ready(function () {
        $("#sma_theme_style").on("change", function () {
            var url = $("#url").val();
            var formData = {
                id: $(this).val(),
            };
    ...
    // select item name from selecting item category name
    $(document).ready(function () {
        $("#sma_theme_rtl").on("change", function () {
            var url = $("#url").val();
            var formData = {
                id: $(this).val(),
            };
    ...
    $(document).ready(function () {
        $("#sma_session").on("change", function () {
            var url = $("#url").val();
            var formData = {
                id: $(this).val(),
            };
    ...
    $("#all_check").click(function () {
        ...
        let allChecked = $(this).html() === "Unselect All";
    ...
    $('input[type="checkbox"].optional_subject').on('change', function () {
        let allSelected = $('input[type="checkbox"].optional_subject:checked').length === $('input[type="checkbox"].optional_subject').length;
...
addSubRowTopic = () => {
    ...
    newRow += "*Allowed Numeric's only";
    newRow += "</span>";
    newRow += "</td>";
    newRow += "<td class='border-top-0'>";
    newRow += "<div class='primary_input mt-2'>";
    newRow += "<input class='primary_input_field form-control' type='number' placeholder='Avg Mark' id='avg_mark" + count + "' name='avg_marks[]' autocomplete='off'>";
    newRow += "</div>";
    ...
    newRow += "<td colspan='3' class='border-top-0'>";
    newRow += "<div class='primary_input mt-2'>";
    newRow += "<input class='primary_input_field form-control' type='file' id='image" + count + "' name='image[]'>";
    newRow += "</div>";
    newRow += "</td>";
    newRow += "</tr>";
